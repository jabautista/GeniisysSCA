...
@WebServlet(name="GIXXGroupedItemsController", urlPatterns="/GIXXGroupedItemsController")
public class GIXXGroupedItemsController extends BaseController{	
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(GIXXGroupedItemsController.class);
	...
	public void doProcessing(HttpServletRequest request,
		...
		try {
			...
			//GIXXGroupedItemsService gixxGroupedItemsService = (GIXXGroupedItemsService) APPLICATION_CONTEXT.getBean("gixxGroupedItemsService"); 
		
			if("getGIXXAccidentGroupedItems".equals(ACTION)){ // for Accident item
				...
				//params = gixxGroupedItemsService.getGIXXAccidentGroupedItems(params);
				...
				if(request.getParameter("refresh") != null && request.getParameter("refresh").equals("1")) {					
					...
					request.setAttribute("accidentGroupedItems", new JSONObject((HashMap<String, Object>)StringFormatter.replaceQuotesInMap(params)));
					PAGE = "/pages/underwriting/policyInquiries/policyInformation/overlay/itemInfoOverlay/accidentGroupedItemsTable.jsp";
				}
			} else if("getGIXXCasualtyGroupedItems".equals(ACTION)){
				Map<String, Object> params = new HashMap<String, Object>();
				params.put("ACTION", ACTION);
				...
				params = TableGridUtil.getTableGrid(request, params);
				//params = gixxGroupedItemsService.getGIXXCasualtyGroupedItems(params);
