...
@WebServlet(name="GIXXBeneficiaryController", urlPatterns="/GIXXBeneficiaryController")
public class GIXXBeneficiaryController extends BaseController{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(GIXXBeneficiaryController.class);
	...
	public void doProcessing(HttpServletRequest request,
		...
		try {
			...
			//GIXXBeneficiaryService gixxBeneficiaryService = (GIXXBeneficiaryService) APPLICATION_CONTEXT.getBean("gixxBeneficiaryService");
			
			if("getGIXXAccidentBeneficiaries".equals(ACTION)){
