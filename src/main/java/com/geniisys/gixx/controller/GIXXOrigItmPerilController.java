...
@WebServlet(name="GIXXOrigItmPerilController", urlPatterns="/GIXXOrigItmPerilController")
public class GIXXOrigItmPerilController extends BaseController {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(GIXXOrigItmPerilController.class);
	...
	public void doProcessing(HttpServletRequest request,
		...
		try {
			...
			if("getGIXXOrigItmPerilList".equals(ACTION)){
