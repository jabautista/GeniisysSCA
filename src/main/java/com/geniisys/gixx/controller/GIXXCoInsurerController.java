...
@WebServlet(name="GIXXCoInsurerController",  urlPatterns="/GIXXCoInsurerController")
public class GIXXCoInsurerController extends BaseController{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(GIXXCoInsurerController.class);
	...
	public void doProcessing(HttpServletRequest request,
		...
		try {
			...
			if("getGIXXCoInsurerList".equals(ACTION)){
