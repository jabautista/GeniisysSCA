...
public interface GIACInwClaimPaytsDAO {
	 ...
	 * @throws SQLException
	 */
	Map<String, Object> saveGIACInwClaimPayts(List<GIACInwClaimPayts> setInwClaimPaytsList, List<GIACInwClaimPayts> delInwClaimPaytsList, Map<String, Object> params) throws SQLException;
}
