...
@WebServlet(name="ACGeneralDisbursementsTransactionsLOVController", urlPatterns={"/ACGeneralDisbursementsTransactionsLOVController"})
public class ACGeneralDisbursementsTransactionsLOVController extends BaseController {
	...
	public void doProcessing(HttpServletRequest request,
		...
		try {		
			...
			if("getGIISReinsurerLOV3".equals(ACTION)){ 
