...
@WebServlet(name="ACGeneralLedgerTransactionsLOVController", urlPatterns={"/ACGeneralLedgerTransactionsLOVController"})
public class ACGeneralLedgerTransactionsLOVController extends BaseController {
	...
	public void doProcessing(HttpServletRequest request,
		...
		try {		
			...
			if ("getGiacs030TranTypeLOV".equals(ACTION)) {
