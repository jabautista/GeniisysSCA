...
/**
 * The Interface GIPIWPolnrepFacadeService.
 */
public interface GIPIWPolnrepFacadeService {
	 ...
	 * @throws SQLException the sQL exception
	 */
	boolean saveWPolnrep(Map<String, Object> parameters) throws SQLException;
	 ...
	 * @throws SQLException the sQL exception
	 */
	String checkPolicyForRenewal(GIPIWPolnrep wpolnrep, String polFlag) throws SQLException;
