...
/**
 * The Interface GIPIParItemFacadeService.
 */
public interface GIPIParItemFacadeService {
	 ...
	 */
	void saveGIPIParItem(Map<String, Object> itemParam) throws SQLException;
	 ...
	 * @throws SQLException the sQL exception
	 */
	void deleteGIPIParItem(Map<String, Object> itemParam) throws SQLException;
	 ...
	 * @throws SQLException the sQL exception
	 */
	void deleteGIPIEndtParItem(Map<String, Object> itemParam) throws SQLException;
	...
	/**
	 * Copy additional info mc for endt par.
	 * 
	 * @param parId the par id
	 * @param itemNo the item no
	 * @param newItemNo the new item no
	...
	/**
	 * For endt par item. Call the stored procedure that will create/update the invoice tables 
	...
	/**
	 * Calls the function ADD_PAR_STATUS_NO for endt par.
	 * @param parId The Par Id
