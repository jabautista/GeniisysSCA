...
/**
 * The Class GIPIWItemDiscount.
 */
public class GIPIWItemDiscount extends BaseEntity{
	...
	public GIPIWItemDiscount(){
		
	}
	
	public GIPIWItemDiscount(final int parId,final String lineCd,final String itemNo,
			final String sublineCd,final BigDecimal discountRt, final BigDecimal discountAmt,
			final String netGrossTag, final BigDecimal origPremAmt,final String sequenceNo, 
			final String remarks, final BigDecimal netPremAmt,
	 ...
	 * Sets the item no.
	 * 
	 * @param itemNos the new item no
	 */
	public void setItemNo(String itemNos) {
		this.itemNo = itemNos;
	}
