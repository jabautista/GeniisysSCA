...
public class GIPIPackEndtText extends BaseEntity{
	...
	public GIPIPackEndtText(){
		super();
	}
	
	public GIPIPackEndtText(Integer packPolicyId, String endtText, String userId, String lastUpdate){
		super();
