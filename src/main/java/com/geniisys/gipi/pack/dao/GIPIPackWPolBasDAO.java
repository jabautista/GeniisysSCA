...
public interface GIPIPackWPolBasDAO {
	...
	void preCommitGIPIS002AInvoice(Integer bookingYear, String bookingMth, Integer parId) throws SQLException;
	Map<String, Object> processPackEndtCancellation(Map<String, Object>params) throws SQLException;
	Map<String, Object> searchForEditedPackPolicy(Map<String, Object> params) throws SQLException;
}
