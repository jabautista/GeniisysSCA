...
/**
 * The Interface GIPIWCommInvoiceDAO.
 */
public interface GIPIWCommInvoiceDAO {
	 ...
	 * Save w comm invoice.
	 * 
	 * @param commInvoices The list of commission invoices to be saved
	 * @param commInvoicePerils The list of commission invoice perils to be saved
	 * @param commInvoicePerilService The service that will be used to saved the comm invoice perils
	 ...
	 * @param setWcommInvoiceList
	 * @param delWcommInvoiceList
	 * @param setWcommInvoicePerilList
	 * @param delWcommInvoicePerilList
	 * @throws SQLException
	 */
	void saveGipiWcommInvoice(List<GIPIWCommInvoice> setWcommInvoiceList, List<GIPIWCommInvoice> delWcommInvoiceList, List<GIPIWCommInvoicePeril> setWcommInvoicePerilList, List<GIPIWCommInvoicePeril> delWcommInvoicePerilList, String parId, String coinsurerSw) throws SQLException;
	 ...
	 * @param globalCancelTag global cancel tag
	 * @return
	 * @throws SQLException
	 */
	 ...
	 * @throws SQLException
	 */
	List<Map<String, Object>> getWCommInvoiceTableGrid(Map<String, Object> params) throws SQLException;
