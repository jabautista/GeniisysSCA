...
/**
 * The Interface GIPIParItemMCDAO.
 */
public interface GIPIParItemMCDAO {
	 ...
	 * @throws SQLException the sQL exception
	 */
	List<GIPIParItemMC> getGIPIParItemMCs(int parId, int itemNo) throws SQLException;
	...
	void setGIPIWVehicle(List<GIPIParItemMC> itemMCs) throws SQLException;
	...
	void updateDeductibleRecords(Map<String, Object> param, int deductibleLevel) throws SQLException;
	void updateItemPerilRecords(Map<String, Object> param) throws SQLException;
	void deleteItem(Map<String, Object> params) throws SQLException;
}
