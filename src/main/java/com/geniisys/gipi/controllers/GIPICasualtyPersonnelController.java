...
public class GIPICasualtyPersonnelController extends BaseController{
	...
	public void doProcessing(HttpServletRequest request,
		...
		try{
			...
			GIPICasualtyPersonnelService gipiCasualtyPersonnelService = (GIPICasualtyPersonnelService) APPLICATION_CONTEXT.getBean("gipiCasualtyPersonnelService");
			
			if("getCasualtyItemPersonnel".equals(ACTION)){
				...
				params = gipiCasualtyPersonnelService.getCasualtyItemPersonnel(params);
				if(request.getParameter("refresh") != null && request.getParameter("refresh").equals("1")) {
					...
					request.setAttribute("casualtyPersonnel", new JSONObject((HashMap<String, Object>)StringFormatter.replaceQuotesInMap(params)));
