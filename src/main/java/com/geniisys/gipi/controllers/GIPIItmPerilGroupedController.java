...
public class GIPIItmPerilGroupedController extends BaseController{
	...
	public void doProcessing(HttpServletRequest request,
		...
		try{
			...
			GIPIItmPerilGroupedService gipiItmPerilGroupedService = (GIPIItmPerilGroupedService) APPLICATION_CONTEXT.getBean("gipiItmPerilGroupedService");
			
			if("getItmPerilGroupedList".equals(ACTION)){
				...
				params = gipiItmPerilGroupedService.getItmPerilGroupedList(params);
				if(request.getParameter("refresh") != null && request.getParameter("refresh").equals("1")) {
					...
					request.setAttribute("itmperilGroupList", new JSONObject((HashMap<String, Object>)StringFormatter.replaceQuotesInMap(params)));
					PAGE = "/pages/underwriting/policyInquiries/policyInformation/overlay/itemInfoOverlay/accidentItemCoverageTable.jsp";
				}
