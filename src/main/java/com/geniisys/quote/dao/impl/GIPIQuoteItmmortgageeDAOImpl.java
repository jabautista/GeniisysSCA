...
public class GIPIQuoteItmmortgageeDAOImpl implements GIPIQuoteItmmortgageeDAO{
	...
	@Override
	public List<GIPIQuoteItmmortgagee> getItmMortgagee(
			Map<String, Object> params) throws SQLException {
		@SuppressWarnings("unchecked")
		List<GIPIQuoteItmmortgagee> itmMortgagee = (List<GIPIQuoteItmmortgagee>)this.getSqlMapClient().queryForList("getDetailMortgageeList", params);
		return itmMortgagee;
	}
	...
	public List<GIPIQuoteItmmortgagee> getItmMortgagee(
			Map<String, Object> params) throws SQLException {
		List<GIPIQuoteItmmorgagee> itmMortgagee = (List<GIPIQuoteItmmortgagee>)this.getSqlMapClient().queryForList(arg0)
		return null;
	}
*/
	/*@SuppressWarnings("unchecked")
