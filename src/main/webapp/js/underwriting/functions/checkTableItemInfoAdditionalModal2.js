function checkTableItemInfoAdditionalModal2(tableName,tableRow,rowName,attr,pkValue,attr2,pkValue2){
	var exist = 0;
	$$("div#"+tableName+" div[name='"+rowName+"']").each(function (div) {
		div.removeClassName("selectedRow");
		if (div.getAttribute(attr) == pkValue && div.getAttribute(attr2) == pkValue2){
			exist = exist + 1;
		}
	});
	if (exist > 5) {
