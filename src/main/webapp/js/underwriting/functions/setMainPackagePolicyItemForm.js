 ...
 */
function setMainPackagePolicyItemForm(obj){
	try{		
		...
		Removed the assigning of values of $("packLineCd").value and $("packSublineCd").value for the package policy items because it causes an null error when adding an item after
		the user has selected and deselected an item beforehand. -irwin 
		*/
		...
		showErrorMessage("setMainPackagePolicyItemForm", e);
	}
}