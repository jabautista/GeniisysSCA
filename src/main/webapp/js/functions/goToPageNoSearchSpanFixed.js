 ...
 * Purpose		: Similar to goToPageNo only, the searchSpan element is at fixed location.
 * 				  Ideal usage for tableListings placed on overlay*/
function goToPageNoSearchSpanFixed(listingTableId, url, action, pageNo) {
	try {
		...
		showErrorMessage("goToPageNoSearchSpanFixed", e);
	}
}