...
<div id="overideUserMainDiv" class="sectionDiv" style="width: 307px; margin: 5px 10px;" align="center">
	<table border="0" align="center" style="margin-top: 10px; width:100%;" >
		<tr>
			...
			<td class="leftAligned" style="width:68%;"><input type="text" id="overideUserName" tabindex="1" style="width: 150px;" value="" maxlength="8"/></td>
		</tr>	
		<tr>
			<td class="rightAligned" >Password</td>
			<td class="leftAligned"><input type="password" id="overidePassWord" style="width: 150px;" tabindex="2" value="" maxlength="50"/></td>	
		</tr>
	</table>
</div>
...
<script>
	...
	$("btnOverideOk").observe("click", function (){
		...
		new Ajax.Request(contextPath+"/GIACDirectPremCollnsController?action=validateOverideUserDtls2" , {
				method: "GET",
				parameters: {
					userName: $F("overideUserName"),
					password: $F("overidePassWord"),
					funcName: objAC.funcName,
