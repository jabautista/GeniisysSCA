...
<script type="text/javascript">
	...
	$("btnCancel").observe("click", function(){
		finalLossReportPrintDialog.close();
	});
	...
	function printFinalLossReport(){
		try {
			var content = contextPath+"/PrintFinalLossReportController?action=printFinalLossReport&claimId="+objCLMGlobal.claimId+"&noOfCopies="+$F("txtNoOfCopies")+"&printerName="+$F("selPrinter")+"&destination="+$F("selDestination")+
					"&riCd="+objCLMGlobal.riCd; //+"advFlaId"+objCLM.fla.advFlaId;
			if($F("selDestination") == "screen"){
				showPdfReport(content, "Final Loss Report");
			...
			showErrorMessage("printFinalLossReport", e);
		}
	}
