...
<script type="text/javascript">
	...
	var objTGReinsurerInfoDetails = JSON.parse('${riResTG}'.replace(/\\/g,'\\\\'));
	var colTitle = '${prelim}' == 'N' ? 'Net Amount' : 'Reserve';
	try{
		var reinsurerModel = {
				url: contextPath+"/GICLReserveSetupController?action=getReserveRi&refresh=1&claimId=${claimId}&shareCd=${shareCd}&perilCd=${perilCd}", // Lara - 10-01-2013 - added perilCd
			options: {
				title: '',
	          	height: '250px',
	          	width: '492px',
