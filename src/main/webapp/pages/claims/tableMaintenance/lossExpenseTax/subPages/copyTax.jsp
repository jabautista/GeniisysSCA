<div class="sectionDiv" style="width: 380px; margin-top: 5px;">
	<div id="copyTaxTableDiv" style="padding-top: 10px; padding-bottom: 10px">
		<div id="copyTaxTable" style="height: 311px; padding-left: 10px;"></div>
	</div>
</div>
<div align="center">
...
<script type="text/javascript">	
	...
	function copyTaxToIssueSource(){
		for ( var i = 0; i < group.length; i++) {
			new Ajax.Request(contextPath+"/GIISLossTaxesController", {
				method: "POST",
				parameters : {
								action : "copyTaxToIssuingSource",
								taxType: unescapeHTML2('${taxType}'),
								taxCd:	unescapeHTML2('${taxCd}'),
	...
	var jsonCopyTax = JSON.parse('${jsonCopyTax}');	
		...
		copyTaxTable = {
				url : contextPath+"/GIISLossTaxesController?action=showCopyTax&refresh=1&issCd="+objIssCd.issCd,
				options: {
					width: '360px',
					pager: {
					},
		...
		tbgCopyTax = new MyTableGrid(copyTaxTable);
		tbgCopyTax.pager = jsonCopyTax;
		tbgCopyTax.render('copyTaxTable');
		var x = true;
