...
<div id="intermediaryMainDiv" name="intermediaryMainDiv">
	<div id="intermediaryTableGridDiv" align="center">
		<div id="intermediaryGridDiv" style="height: 330px; margin-top: 5px;">
			<div id="intermediaryTableGrid" style="height: 306px; width: 580px;"></div>
		</div>
...
<script type="text/javascript">
	try {
		...
		var claimsTableModel = {
				url: contextPath+"/GICLClaimsController?action=getBasicIntmDtls&claimId=" + objCLMGlobal.claimId +"&refresh=1",
				options:{
					title: '',
					width: '580px',
		...
		claimsListTableGrid.render('intermediaryTableGrid');
			
	} catch(e){
		showErrorMessage("intermediary.jsp", e);
	}
