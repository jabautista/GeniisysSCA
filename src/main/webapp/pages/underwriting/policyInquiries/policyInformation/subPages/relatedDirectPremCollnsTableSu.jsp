...
<script>
	...
	try{
		...
		showErrorMessage("GIPIS100 - Bonds Premium Collns", e);
	}
	...
	function loadDirectPrem(collns){
		...
		$("txtLastUpdate").value = nvl(collns.lastUpdate, null) == null ? "" : dateFormat(collns.lastUpdate,"mm-dd-yyyy HH:MM:ss TT");
	}
