<table style="width:600px;margin:5 auto 0 auto;">
	<tr>
		<td style="width:115px;" class="rightAligned">Bancassuranc Type</td>
		<td style="width:60px;">
...
<script>
	...
	try{
		...
		var objPolBancassuranceDtl = JSON.parse('${polBancassuranceDtl}'.replace(/\\/g, '\\\\'));
