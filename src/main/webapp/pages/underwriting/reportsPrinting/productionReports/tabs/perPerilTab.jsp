		...
		<div class="" style="float: left; padding:15px 0 15px 0;">
			...
			<div id="typeDiv" name="typeDiv" class="sectionDiv" style="width: 300px; float: right; margin-right: 15px;">
				...
				<div style="border-bottom: 1px solid #E0E0E0; width: 300px; float: right;">
					<table align="left" style="margin: 3px;">
						<tr><td><input value="1" title="Per Peril" type="radio" id="perPeril" name="perilAgentRG" style="margin: 0 5px 0 5px; float: left;"><label for="perPeril">Per Peril</label></td></tr>
						<tr><td><input value="2" title="Per Agent" type="radio" id="perAgent" name="perilAgentRG" style="margin: 0 5px 0 5px; float: left;"><label for="perAgent">Per Agent</label></td></tr>
					</table>
				</div>
				<div style="border-bottom: 1px solid #E0E0E0; width: 300px; float: right;">
					<table align="left" style="margin: 3px;">
...
<script type="text/javascript">
	...
	function printUwReports(){
		if($("detail").checked && $("perAgent").checked){
			printProdReport("printGIPIR946D");
			//GIPIR946D
		}else if($("summary").checked && $("perAgent").checked){
			printProdReport("printGIPIR946F");
			//GIPIR946F
		}else if($("detail").checked && $("perPeril").checked){
			printProdReport("printGIPIR946");
		}else if($("summary").checked && $("perPeril").checked){
			printProdReport("printGIPIR946B");
			//GIPIR946B
		}
	}
	...
	function getReportTitle(action){
		var title = "";
		if(action == "printGIPIR946"){
			title = "Detailed Production Register Per Peril";
		}else if(action == "printGIPIR946B"){
			title="Summarized Production Register Per Peril";
		}else if(action == "printGIPIR946D"){
			title="Detailed Production Register Per Agent";
		}else if(action == "printGIPIR946F"){
			title="Summarized Production Register Per Agent";
		}
		return title;
	}
	...
	observeReloadForm("reloadForm", function(){showUWProductionReportsPage("perPeril");});
