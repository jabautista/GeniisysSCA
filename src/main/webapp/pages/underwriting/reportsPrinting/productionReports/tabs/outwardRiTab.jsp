...
<script type="text/javascript">
	...
	function printUwReports(){
		if($("summary").checked){
			printProdReport("printGIPIR930A");
		}else{
			printProdReport("printGIPIR930");
		}
	}
	...
	function getReportTitle(action){
		var title = "";
		if(action == "printGIPIR930A"){
			title = "Summarized Outward Ri Production Report";
		}else if(action == "printGIPIR930"){
			title = "Detailed Outward Ri Production Report";
		}
	...
	observeReloadForm("reloadForm", function(){showUWProductionReportsPage("showOutwardRiTab");});
