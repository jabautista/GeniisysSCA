		...
		<table id="fireTable" width="920px" cellspacing="1" border="0">
			...
			<tr>
				...
				<td class="leftAligned">
					...
					<div style="float: left; border: solid 1px gray; width: 179px; height: 21px; margin-right: 3px;" class="required" >						
						<textarea tabindex="36" onKeyDown="limitText(this, 2000);" onKeyUp="limitText(this, 2000);" style="float: left; margin-top: 0px; margin-right: 3px; width: 152px; height: 13px; border: none; resize: none;" name="front" id="front" value="" class="required" ></textarea>
			...
			<tr>
				...
				<td class="leftAligned">
					...
					<div style="float: left; border: solid 1px gray; width: 179px; height: 21px; margin-right: 3px;" class="required" >						
						<textarea tabindex="37" onKeyDown="limitText(this, 2000);" onKeyUp="limitText(this, 2000);" style="float: left; margin-top: 0px; margin-right: 3px; width: 152px; height: 13px; border: none; resize: none;" name="right" id="right" value="" class="required"></textarea>
			...
			<tr>				
				...
				<td class="leftAligned">
					...
					<div style="float: left; border: solid 1px gray; width: 179px; height: 21px; margin-right: 3px;" class="required" >						
						<textarea tabindex="38" onKeyDown="limitText(this, 2000);" onKeyUp="limitText(this, 2000);" style="float: left; margin-top: 0px; margin-right: 3px; width: 152px; height: 13px; border: none; resize: none;" name="left" id="left" value="" class="required"></textarea>
			...
			<tr>
				...
				<td class="leftAligned">
					...
					<div style="float: left; border: solid 1px gray; width: 179px; height: 21px; margin-right: 3px;" class="required" >						
						<textarea tabindex="39" onKeyDown="limitText(this, 2000);" onKeyUp="limitText(this, 2000);" style="float: left; margin-top: 0px; margin-right: 3px; width: 152px; height: 13px; border: none; resize: none;" name="rear" id="rear" value="" class="required"></textarea>
...
<script type="text/javascript">
	...
	function showBlock(column){
		...
		showDistrictBlock(regionCd, provinceCd, cityCd, districtNo);
	...
	function validateFromDate(){
		if(!($F("fromDate").empty())){
			...
			if(fromDate > expiryDate){
				$("fromDate").value = (((objGIPIWPolbas.inceptDate).split(" "))[0]);
	...
	function validateToDate(){
		if(!($F("toDate").empty())){
			...
			if(toDate > expiryDate){
				$("toDate").value = ((objGIPIWPolbas.expiryDate).split(" "))[0];
