				...
				<td style="920px;">
					<table cellspacing="0" border="0" style="margin-bottom: 20px;">
						<tr>
							...
							<td class="leftAligned" style="width: 200px;"><input type="text" tabindex="1" style="width: 194px; padding: 2px;" id="itemNo" name="itemNo" class="required" maxlength="9"/></td>
...
<!-- 									<tr align="center"><td><input type="button" style="width: 100%;" id="btnLocation"	 		name="btnWItem" 			class="disabledButton" 	value="Location"	 			disabled="disabled" /></td></tr>
									<tr align="center"><td><input type="button" style="width: 100%;" id="btnDefaultLoc" 		name="btnWItem" 			class="disabledButton" 	value="Default Location"		disabled="disabled" /></td></tr>
 -->							
 								</table>
							</td>
						</tr>
