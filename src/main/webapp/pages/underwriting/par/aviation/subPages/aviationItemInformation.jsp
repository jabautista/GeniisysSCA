						...
						<tr>				
							...
							<td rowspan="6">
								<table cellpadding="1" border="0" align="center" style="width: 150px;">
									<tr align="center"><td><input type="button" style="width: 100%; display: none;" id="btnCopyItemInfo" 		name="btnWItem" 			class="disabledButton" 	value="Copy Item Info" 			disabled="disabled" /></td></tr>
									<tr align="center"><td><input type="button" style="width: 100%; display: none;" id="btnCopyItemPerilInfo" 	name="btnWItem" 			class="disabledButton" 	value="Copy Item/Peril Info" 	disabled="disabled" /></td></tr>
									...
									<tr align="center"><td><input type="button" style="width: 100%;" id="btnAttachMedia" 		name="btnWItem" 			class="disabledButton noChangeTagAttr" 	value="Attach Media" 			disabled="disabled" /></td></tr>									
								</table>
							</td>
						</tr>
						<tr>
...
<jsp:include page="/pages/underwriting/par/aviation/subPages/aviationItemInfoAdditional.jsp"></jsp:include>
<script type="text/javascript">
	...
	objGIPIWItem = JSON.parse(Object.toJSON(formMap.itemAviations));
