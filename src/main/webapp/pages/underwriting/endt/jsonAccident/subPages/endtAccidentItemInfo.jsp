				...
				<td style="width: 920px;">
					<table cellspacing="0" border="0" style="margin-bottom: 0px; width: 895px;">
						<tr>				
							...
							<td rowspan="6">
								<table cellpadding="1" border="0" align="center" style="width: 150px;">
									...
									<tr align="center"><td><input type="button" style="width: 100%;" id="btnDeleteAddAllItems" 	name="" 					class="button" 			value="Delete/Add All Items" /></td></tr>						
									<tr align="center"><td><input type="button" style="width: 100%;" id="btnAssignDeductibles" 	name="btnWItem" 			class="disabledButton" 	value="Assign Deductibles" 		disabled="disabled" /></td></tr>						
						...
						<tr>
							...
							<td colspan="4" class="leftAligned">
								...
								<div style="float:left; width: 100px; margin: none;">
									<input class="rightAligned" type="text" id="accidentDaysOfTravel" name="accidentDaysOfTravel" value="" style="width: 100px; height: 13px;" readonly="readonly"></div>
						...
						<tr>
							...
							<td class="rightAligned" style="display : none;">Condition
							...
							<td class="leftAligned">
								...
								<select id="accidentProrateFlag" name="accidentProrateFlag" style="width:230px; display : none;" class="required">
...
/*		var ahInfoObj = objGIPIWItem.gipiWAccidentItem; 
	...
	$("btnAttachMedia").observe("click", function(){
		// openAttachMediaModal("par"); //kenneth @fgic 11072014
