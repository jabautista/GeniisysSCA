...
<div id="itemInfoMainDiv">
	<div class="sectionDiv" id="itemInformationDiv">
		<jsp:include page="/pages/underwriting/endt/common/endtItemInformationListingTable.jsp"></jsp:include>
			...
			<table width="100%">
				<tr>
					<td style="width:728px;">
						<table cellspacing="0" border="0" style="margin-bottom: 0px; width: 728px;">					
							<tr>				
								...
								<td class="leftAligned" style="width: 220px;"><input type="text" tabindex="2" style="width: 224px; padding: 2px;" id="itemTitle" name="itemTitle" maxlength="250" /></td>
							</tr>
							<tr>
								...
								<td class="leftAligned">
									<select tabindex="7" id="coverage" name="coverage" style="width: 230px;">
										...
										<c:forEach var="coverage" items="${coverages}">
											<option value="${coverage.code}">${coverage.desc}</option>				
										</c:forEach>
									</select>
								</td>
							...
							<tr>
								...
								<td id="riskCell1" style="display: none;" class="rightAligned">Risk No.</td>
	...
	<jsp:include page="/pages/underwriting/endt/jsonFire/subPages/endtFireItemInfoAdditional.jsp"></jsp:include>
</div>
<script type="text/javascript">
	...
	objPolbasics = JSON.parse('${gipiPolbasics}'); // andrew - 08062015 - KB 310
	objParPolbas = JSON.parse('${gipiWPolbas}'); // andrew - 08062015 - KB 310
...
/* 		var formattedFromdate 			= (makeDate($F("fromDate")));
		var formattedTodate 			= (makeDate($F("toDate")));  removed by CarloR 08.17.2016 SR-22958*/
		var formattedFromdate;   //Added by CarloR to avoid formatting error when date is null SR-22958 Start
		var formattedTodate;
		
	    if($F("fromDate") == ""){
			formattedFromdate = null;
		}else{
			formattedFromdate = (makeDate($F("fromDate")));
		}
	    
		if($F("toDate") ==""){
			formattedTodate = null;
		}else{
			 formattedTodate 			= (makeDate($F("toDate")));
		} //End
