	...
	<div class="sectionDiv" id="additionalItemInformation" style="margin: 0px;" changeTagAttr="true" masterDetail="true" >		
		...
		<table id="motorcarTable" width="920px" cellspacing="1" border="0">
			...
			<tr>
				...
				<td class="leftAligned" style="width: 185px;"><input type="text" tabindex="8" style="width: 175px; padding: 2px;" name="assignee" id="assignee" maxlength="250" /></td>
			...
			<tr>
				...
				<td class="leftAligned">
					<div style="float: left; border: solid 1px gray; width: 179px; height: 20px; margin-right: 3px;">
						...
						<input type="text" tabindex="16" style="float: left; margin-top: 0px; margin-right: 3px; width: 150px; border: none;" name="basicColor" id="basicColor" readonly="readonly" value=""/>
...
<%-- 					<select tabindex="20" id="basicColor" name="basicColor" style="width: 180px;">
				...
				<td class="leftAligned">
					<div style="float: left; border: solid 1px gray; width: 179px; height: 20px; margin-right: 3px;">
						...
						<input type="text" tabindex="16" style="float: left; margin-top: 0px; margin-right: 3px; width: 150px; border: none;" name="color" id="color" readonly="readonly" value=""/>
...
<%-- 					<input type="hidden" id="color" name="color" value="" />
			...
			<tr>
				...
				<td class="leftAligned"><input type="text" tabindex="26" style="width: 175px; padding: 2px;" name="serialNo" id="serialNo" maxlength="25" class="required"/></td> <!-- added by steven 09.04.2014 - required -->
			...
			<tr>
				...
				<td class="leftAligned" colspan="3">					
					...
					<label for="ctv"><div title="Motorcar Trailer Vehicle Type Tag"><input type="checkbox" tabindex="32" style="width: 10px; padding: 2px; float: left;" id="ctv"/>CTV</div></label>
				</td>					
...
try{
	...
	$("towLimit").observe("blur", function(){
		if(!($F("towLimit").empty())){
			...
			amount = (Number($F("towLimit").replace(/,/g, "")).toFixed(2)).split("."); // added tofixed to correct computation by robert 01.27.15 
			...
			if(sum > 99999999999999.99){
				...
				$("towLimit").value = (Number(parseFloat($F("towLimit"))).toFixed(2)); //added by robert to format 01.29.2015
			}				
	...
	checkIfCancelledEndorsement(); //added by jdiago 08.05.2014 : to check if fields are to be disabled.
}catch(e){
