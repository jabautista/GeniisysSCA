				...
				<td style="width: 920px;">
					<table cellspacing="0" border="0" style="margin-bottom: 0px; width: 895px;">					
						<tr>				
							...
							<td class="leftAligned"><input type="text" tabindex="2" style="width: 224px; padding: 2px;" id="itemTitle" name="itemTitle" maxlength="50" class="required"/></td>
							<td rowspan="6">
						...
						function(response){							
							if (checkErrorOnResponse(response)) {	
								if(response.responseText != 'Empty'){
									...
									showMessageBox(response.responseText, imgMessage.WARNING);	//changed by kenneth L. 03.27.2014
									return false;
								}else{//added kenneth L. 03.27.2014
									setDefaultItemForm();
								}		
							}
						} 
