...
<jsp:include page="/pages/underwriting/endt/accident/subPages/endtBeneficiaryInformationListing.jsp"></jsp:include>
...
<script type="text/javascript">
	...
	function addBeneficiary() {	
		try	{
			...
			var bBenefeciaryRemarks = changeSingleAndDoubleQuotes2($("benefeciaryRemarks").value);
			var exists = false;
			...
			$$("div[name='ben']").each( function(a)	{
				...
				//added by angelo -- when-validate-item for beneficiary name
				if ((a.down("input", 3).value) == bBeneficiaryName && $F("btnAddBeneficiary") != "Update"){
					exists = true;
					showMessageBox('Beneficiary name must be unique.', imgMessage.ERROR);
				} 
			});
			...
			if (!exists)	{
				var content = '<input type="hidden" id="bParIds" 		     		name="bParIds" 	        		 value="'+bParId+'" />'+
							  ...
							  '<input type="hidden" id="bBeneficiaryNos"       		name="bBeneficiaryNos"     	 	 value="'+bBeneficiaryNo+'" />'+ 
						 	  ...
						 	  '<label name="textBenefeciary" style="width: 20%; margin-right: 3px; margin-left:7px;" for="ben'+bBeneficiaryName+'">'+bBeneficiaryName.truncate(20, "...")+'</label>'+
