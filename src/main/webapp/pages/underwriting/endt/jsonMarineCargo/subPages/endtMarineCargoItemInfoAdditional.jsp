	...
	<div class="sectionDiv" id="additionalItemInformation" style="margin: 0px;" masterDetail="true">
		<table id="marineCargoTable" width="920px" cellspacing="1" border="0">
			...
			<tr>
				...
				<td class="leftAligned">
					<div id="cargoClassDiv" style="float:left; border: solid 1px gray; width: 226px; height: 21px; margin-right:4px;" class="required">
						<input type="hidden" id="cargoClassCd" name="cargoClassCd" />
						<input type="text" tabindex="17" style="float: left; margin-top: 0px; margin-right: 3px; width: 197px; border: none;" name="cargoClass" id="cargoClass" readonly="readonly" class="required" value="" tabindex="19" />
			...
			<tr>
				...
				<%-- <td class="leftAligned"> bonok :: 09.17.2012
				...
				<td class="leftAligned"> 
					<div id="cargoTypeDiv" style="float:left; border: solid 1px gray; width: 226px; height: 21px; margin-right:4px;" class="required">
						<input type="hidden" id="cargoType" name="cargoType" />
						<input type="text" tabindex="18" style="float: left; margin-top: 0px; margin-right: 3px; width: 197px; border: none;" name="cargoTypeDesc" id="cargoTypeDesc" readonly="readonly" class="required" value="" tabindex="18" />
...
<script type="text/javascript">
	...
	$("hrefCargoClass").observe("click", showCargoClassLOV); //ROBERT 9.18.2012
	
	$("hrefCargoType").observe("click", function(){	// bonok :: 09.17.2012
	...
	$("invCurrCd").observe("focus", function(){
		//$("invCurrCd").hide(); commented out by gab 05.26.2016 SR 21693
		...
		if(length > 0){
			showConfirmBox("Delete Peril", "There are existing perils already, any change or update for Invoice Value, Mark-Up Rate or Currency Rate will " + 
				...
				function(){
					...
					deleteFromItemPeril($F("itemNo")); //modified by gab 05.25.2016 SR 21693
					for(var i=0, length=objGIPIWItemPeril.length; i<length; i++){
						if(objGIPIWItemPeril[i].perilType == "B"){
							$("tsiAmt").value = parseFloat(nvl($F("tsiAmt").replace(/,/g, ""), 0)) - objGIPIWItemPeril[i].tsiAmt;
							$("annTsiAmt").value = parseFloat(nvl($F("annTsiAmt").replace(/,/g, ""), 0)) - objGIPIWItemPeril[i].annTsiAmt;
						}
						$("premAmt").value = parseFloat(nvl($F("premAmt").replace(/,/g, ""), 0)) - objGIPIWItemPeril[i].premAmt;
						$("annPremAmt").value = parseFloat(nvl($F("annPremAmt").replace(/,/g, ""), 0)) - objGIPIWItemPeril[i].annPremAmt;
					}
				}, 
				function(){					
					$("invCurrCd").focus();
