...
<div id="itemInfoMainDiv">
	...
	<jsp:include page="/pages/underwriting/endt/jsonAviation/subPages/endtAviationItemInfoAdditional.jsp"></jsp:include>
</div>
<script type="text/javascript">
	...
	objPolbasics = JSON.parse('${gipiPolbasics}'); // andrew - 08062015 - KB 308
	objParPolbas = JSON.parse('${gipiWPolbas}'); // andrew - 08062015 - KB 308
