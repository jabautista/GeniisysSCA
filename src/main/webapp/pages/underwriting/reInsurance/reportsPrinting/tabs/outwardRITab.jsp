	...
	<div id="fieldsDiv" name="fieldsDiv" class="sectionDiv" style="margin-left: 15px; padding-top: 5px; width: 890px; height: 180px;">
		<table id="fieldsTbl" style="margin: 50px 0 0 250px;">
			...
			<tr>
				...
				<td><input id="txtReportYear" name="txtReportYear" type="text" class="integerNoNegativeUnformattedNoComma" maxlength="4" value="" style="width: 178px; text-align: right;" errorMsg="Legal characters are 0-9."></td>
			</tr>
		</table>
	</div>
...
<script type="text/javascript">
	...
	observeReloadForm("reloadForm", function(){showGenerateRIReportsTabPage("outwardRITab");});
	...
	$("btnPrint").observe("click", function(){
		if($F("selDestination") == "PRINTER" && ($("selPrinter").value == "" || $("txtNoOfCopies").value == "")){
			...
			var reportId = "GIRIR108";		
			
			var content = contextPath+"/UWReinsuranceReportPrintController?action=printUWRiOutwardReport&reportId="+reportId+"&reportMonth="+
			 			  $F("selReportMonth")+"&reportYear="+$F("txtReportYear")+"&noOfCopies="+$F("txtNoOfCopies")+"&printerName="+
			  			  $F("selPrinter")+"&destination="+$F("selDestination");

			if($F("selDestination") == "SCREEN"){
				showPdfReport(content, "Outward Reinsurance Summary");
