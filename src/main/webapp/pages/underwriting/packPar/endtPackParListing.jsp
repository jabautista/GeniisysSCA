...
<div id="packParListingMainDiv" name="packParListingMainDiv" style="display: none;" module="packParListing">
	...
	<input type="hidden" 	id="globalSublineCd" 	name="globalSublineCd"/>
	<input type="hidden"	id="globalParType" 		name="globalParType" 	value="E"> <!-- emman 11.17.10 (changed par type to E) -->
	...
	<div id="outerDiv" name="outerDiv">
		<div id="innerDiv" name="innerDiv">
			<label id="">List of Endorsement Package Policy Action Records for ${lineName }</label>
...
<script>
	...
	$("keyword").observe("keypress", function (evt) {
		if (13 == evt.keyCode) {
			goToPageNo("packParListingTable", "/GIPIPackPARListController?ajax=1&lineCd="+objUWGlobal.lineCd+"&parType=E", "showPackParList", 1);
		}
	});
