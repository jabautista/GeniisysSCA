...
<div id="accidentModalMainDiv" style="height:525px; overflow-y:auto; ">
	...
	<div id="groupedItemsDetail">
		...
		<jsp:include page="/pages/underwriting/pop-ups/accidentGroupedItems.jsp"></jsp:include>
	</div>
	...
	<div id="popBenDiv">
		...
		<jsp:include page="/pages/underwriting/pop-ups/accidentPopulateBenefits.jsp"></jsp:include>
	</div>
	...
	<div id="coverageDetail">
		...
		<jsp:include page="/pages/underwriting/pop-ups/accidentCoverage.jsp"></jsp:include>	
	</div>
	...
	<div id="beneficiaryDetail">
		...
		<jsp:include page="/pages/underwriting/pop-ups/accidentBeneficiary.jsp"></jsp:include>	
	</div>
	
	<div class="buttonsDiv">
		<input type="button" class="button"  id="btnCancelGrp" name="btnCancelGrp"  value="Cancel" 	style="width: 60px;" />
		<input type="button" class="button"  id="btnSaveGrp" 	name="btnSaveGrp" 	  value="Save" 		style="width: 60px;" />
	</div>	
	</form>
</div>
<script type="text/javascript">
	...
	$("btnSaveGrp").observe("click",function(){
		...
		if (ctr<2){
			showMessageBox("Minimum no. of Grouped Items is two(2).", imgMessage.ERROR);
			return false;
