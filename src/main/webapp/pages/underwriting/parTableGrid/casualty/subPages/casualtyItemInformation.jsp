...
<div class="sectionDiv" id="itemInformationDiv">
	...
	<jsp:include page="/pages/underwriting/parTableGrid/casualty/subPages/casualtyItemInfoAdditional.jsp"></jsp:include>
</div>
	...
	function addItem(){
		...
		if(isParItemInfoValid()){
			if(!(itemTitle.blank()) && $F("txtLocation").blank() && $F("selSectionOrHazardCd").blank() &&
				...
				customShowMessageBox("Please enter a value for at least one of the following fields before proceeding to another item: Location of Risk, Section/Hazard, Capacity.",
