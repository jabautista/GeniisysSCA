...
%>
<div id="packQuoteWCDiv" name="packQuoteWCDiv" style="margin: 10px; margin-bottom: 30px;"">
	<div class="tableHeader" id="packQuoteWCTable" name="packQuoteWCTable">
	...
	<div class="tableContainer" id="packQuotationWCList" name="tableContainer"></div>
</div>
