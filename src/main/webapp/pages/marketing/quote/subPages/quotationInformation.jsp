...
try{ // modofied by: Nica 06.13.2012 - added unescapeHTML2
	objGIPIQuote = JSON.parse('${gipiQuoteObj}');
	$("txtQuotationNumber").value = unescapeHTML2(objGIPIQuote.dspQuotationNo); // added unescapeHTML2 by robert 11.11.13
	$("txtAcceptDate").value = dateFormat(objGIPIQuote.strAcceptDt, "mm-dd-yyyy"); //Modified by Jerome 09.29.2016 SR 5691
	$("txtAssuredName").value = unescapeHTML2(objGIPIQuote.assdName);
	$("txtUserId").value = unescapeHTML2(objGIPIQuote.userId);
	$("txtInceptionDate").value = dateFormat(objGIPIQuote.inceptDate, "mm-dd-yyyy"); //Modified by Jerome 09.06.2016 SR 5642
	$("txtNoOfDays").value = objGIPIQuote.noOfDays;
	$("txtExpirationDate").value = dateFormat(objGIPIQuote.expiryDate, "mm-dd-yyyy"); //Modified by Jerome 09.06.2016 SR 5642

	observeReloadForm("reloadForm", showQuotationInformation);
