...
<div id="additionalItemInformationDiv" name="additionalItemInformationDiv" style="display: none;">	
	<div class="sectionDiv" id="additionalItemInformation" style="margin: 0px; display: none;" changeTagAttr="true" masterDetail="true" >		
		...
		<table id="motorcarTable" width="920px" cellspacing="1" border="0">
			...
			<tr>
				...
				<td class="leftAligned" style="width: 185px;">
					<input type="text" tabindex="8" style="width: 175px; padding: 2px;"	name="assignee" id="assignee" maxlength="250" class="aiInput"/>
				</td>
				<td class="rightAligned">Acquired From</td>
				<td class="leftAligned" style="width: 185px;">
					<input type="text" tabindex="9" style="width: 175px; padding: 2px;" name="acquiredFrom" id="acquiredFrom" maxlength="30" class="aiInput"/>
				</td>
				<td class="rightAligned" style="width: 100px;">Motor/Eng No.</td>
				<td class="leftAligned" style="width: 190px;">
					<input type="text" tabindex="10" style="width: 175px; padding: 2px;" name="motorNo" id="motorNo" maxlength="30" class="aiInput"/><!-- changed maxlength to 30 reymon 03312014 -->
				</td>
			</tr>
			<tr>
				<td class="rightAligned">Origin </td>
				<td class="leftAligned">
					<input type="text" tabindex="11" style="width: 175px; padding: 2px;" name="origin" id="origin" maxlength="50" class="aiInput"/></td>
				<td class="rightAligned">Destination </td>
				<td class="leftAligned">
					<input type="text" tabindex="12" style="width: 175px; padding: 2px;" name="destination" id="destination" maxlength="50" class="aiInput"/>
				</td>
				<td class="rightAligned">Type of Body </td>
				<td class="leftAligned">
					<select tabindex="13" id="typeOfBody" name="typeOfBody" style="width: 180px;" class="aiInput">
						<option value=""></option>
			...
			<tr>
				...
				<td class="leftAligned">
					<input type="text" tabindex="14" style="width: 175px; padding: 2px;" name="plateNo" id="plateNo" maxlength="10" class="aiInput"/></td>
				<td class="rightAligned">Model Year </td>
				<td class="leftAligned">
					<input type="text" tabindex="15" style="width: 175px; padding: 2px;" name="modelYear" id="modelYear" maxlength="4" class="integerNoNegativeUnformatted aiInput" errorMessage="Invalid Model Year. Value should be from 0001 to 9999."/></td>
				<td class="rightAligned">Car Company </td>
				<td class="leftAligned">
					<div style="float: left; border: solid 1px gray; width: 177px; height: 21px; margin-right: 3px;" class="required">
						<input type="hidden" id="carCompanyCd" name="carCompanyCd"/>
						<input type="text" tabindex="16" style="float: left; margin-top: 0px; margin-right: 3px; width: 150px; border: none;" name="carCompany" id="carCompany" readonly="readonly" value="" class="required aiInput"/>
			...
			<tr>
				...
				<td class="leftAligned">
					<input type="text" tabindex="17" style="width: 175px; padding: 2px;" name="mvFileNo" id="mvFileNo" maxlength="15" class="aiInput"/>
				</td>
				<td class="rightAligned">No. of Pass </td>
				<td class="leftAligned">
					<input type="text" tabindex="18" style="width: 175px; padding: 2px;" name="noOfPass" id="noOfPass" maxlength="3" class="integerNoNegativeUnformatted aiInput" errorMessage="Invalid No. of Pass. Value should be from 1 to 999." />
				</td>
				...
				<td class="leftAligned">
					<div style="float: left; border: solid 1px gray; width: 177px; height: 21px; margin-right: 3px;">
						...
						<input type="text" tabindex="19" style="float: left; margin-top: 0px; margin-right: 3px; width: 150px; border: none;" name="make" id="make" readonly="readonly" value="" class="aiInput"/>
			...
			<tr>
				...
				<td class="leftAligned">
					<div style="float: left; border: solid 1px gray; width: 179px; height: 20px; margin-right: 3px;">
						...
						<input type="text" tabindex="16" style="float: left; margin-top: 0px; margin-right: 3px; width: 150px; border: none;" name="basicColor" id="basicColor" readonly="readonly" value="" class="aiInput"/>
				...
				<td class="leftAligned">
					<div style="float: left; border: solid 1px gray; width: 179px; height: 20px; margin-right: 3px;">
						...
						<input type="text" tabindex="16" style="float: left; margin-top: 0px; margin-right: 3px; width: 150px; border: none;" name="color" id="color" readonly="readonly" value="" class="aiInput"/>
				...
				<td class="leftAligned">
					<div style="float: left; border: solid 1px gray; width: 177px; height: 21px; margin-right: 3px;">
						...
						<input type="text" tabindex="22" style="float: left; margin-top: 0px; margin-right: 3px; width: 150px; border: none;" name="engineSeries" id="engineSeries" readonly="readonly" value="" class="aiInput"/>
			...
			<tr>
				...
				<td class="leftAligned">
					<select tabindex="23" id="motorType" name="motorType" style="width: 180px;" class="aiInput">
						<option value=""></option>
				...
				<td class="leftAligned">
					<input type="text" tabindex="24" style="width: 175px; padding: 2px;" name="unladenWt" id="unladenWt" maxlength="20" class="aiInput"/>
				</td>
				<td class="rightAligned">Tow Limit </td>
				<td class="leftAligned">
					<input type="text" tabindex="25" style="width: 175px; padding: 2px;" name="towLimit" id="towLimit" class="money2 aiInput" maxlength="17" min="0.00" max="99999999999999.99" errorMsg="Invalid Tow Limit. Value should be from 0.00 to 99,999,999,999,999.99" />
				</td>
			</tr>
			<tr>
				<td class="rightAligned">Chassis/Serial No </td>
				<td class="leftAligned">
					<input type="text" tabindex="26" style="width: 175px; padding: 2px;" name="serialNo" id="serialNo" maxlength="25" class="aiInput"/>
				</td>
				<td class="rightAligned">Subline Type </td>
				<td class="leftAligned">
					<select tabindex="27" id="sublineType" name="sublineType" style="width: 180px;" class="aiInput">
						<option value=""></option>
				...
				<td class="leftAligned">
					<input type="text" tabindex="28" style="width: 175px; padding: 2px;" name="deductibleAmount" id="deductibleAmount" class="money2 aiInput" readonly="readonly" maxlength="16" />
				</td>
			</tr>
			<tr>
				<td class="rightAligned">COC No. </td>
				<td class="leftAligned" colspan="3">
					<input type="text" style="width: 10%; float: left;" name="cocType" id="cocType" readonly="readonly" class="aiInput"/><label>-</label>
					<input type="text" tabindex="30" style="width: 12%; float: left;" name="cocSerialNo" id="cocSerialNo" maxlength="7" class="integerNoNegativeUnformatted aiInput" errorMessage="Invalid COC No. (Serial No.). Value should be from 0 to 9999999." /><label>-</label>
					<input type="text" tabindex="31" style="width: 8%; float: left; margin-right: 5px;" name="cocYy" id="cocYy" maxlength="2" class="integerNoNegativeUnformatted aiInput" errorMessage="Invalid COC No. (Year). Value should be from 0 to 99." />
					<input type="checkbox" tabindex="32" style="width: 10px; padding: 2px; float: left;" id="ctv" class="aiInput"/><label for="ctv">CTV</label>
				</td>
				<td class="rightAligned">Repair Limit </td>
				<td class="leftAligned">
					<input type="text" tabindex="33" style="width: 175px; padding: 2px;" name="repairLimit" id="repairLimit" class="money2 aiInput" readonly="readonly" maxlength="20" />
				</td>
			</tr>
		</table>
		<div style="margin-left: auto; margin-right: auto; margin-bottom: 20px;">
			<input type="button" id="aiMCUpdateBtn" name="aiMCUpdateBtn" value="Apply Changes" class="disabledButton"/> <!-- edited by steven 11/7/2012 binago ko ung id niya kasi parehas siya sa ibang jsp na tinatawag dito kaya nag-eerror ung function --> 
		</div>
...
try{
	...
	$("hrefMake").observe("click", function(){
		showOverlayContent2(contextPath + "/GIPIWVehicleController?action=showMake&sublineCd="+objGIPIQuote.sublineCd+"&carCompanyCd="+$F("carCompanyCd"), "Make", 820, "");
	});

	$("hrefEngineSeries").observe("click", function(){
		showOverlayContent2(contextPath + "/GIPIWVehicleController?action=showEngineSeries&sublineCd="+objGIPIQuote.sublineCd+"&carCompanyCd="+$F("carCompanyCd")+"&makeCd="+$F("makeCd"), "Engine Series", 820, "");
	});
...
/* 	$("basicColor").observe("change", function(){					
	...
	*/
	...
	initializeAiType("aiMCUpdateBtn");
	
	$("aiMCUpdateBtn").observe("click", function(){
		if ($("carCompany").value.blank()){
			customShowMessageBox(objCommonMessage.REQUIRED, "E", "carCompany");
		}else{
