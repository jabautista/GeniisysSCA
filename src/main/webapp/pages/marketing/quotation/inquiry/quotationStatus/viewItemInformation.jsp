	...
	<form id="itemInformationListingForm" name="itemInformationListingForm">
		<div id="itemInformationFormDiv">
			...
			<div id="itemInformationDiv" class="sectionDiv">
				<div id="itemInformationListMainDIv" style="padding: 10px 10px 0px 10px;">
						...
						<table cellspacing="1" border="0" style="margin: auto;">
							<tr>
								...
								<td class="leftAligned" style="width: 210px;"><input
									...
									style="width: 210px;" readonly="readonly" class="rightAligned" tabindex="201"/></td>
								...
								<td class="leftAligned"><input id="txtItemTitle"
									...
									maxlength="50" class="upper" tabindex="202" readonly="readonly"/></td>
							</tr>
							<tr>
								...
								<td class="leftAligned" colspan="3">
									<div
										...
										<textarea id="txtItemDesc" name="txtItemDesc"
											...
											style="width: 490px; border: none; height: 13px;" class="" tabindex="203" readonly="readonly"></textarea>
								...
								<td class="leftAligned" colspan="3">
									<div
										...
										<textarea id="txtItemDesc2" name="txtItemDesc2"
											onKeyDown="limitText(this,2000);"
											onKeyUp="limitText(this,2000);"
											style="width: 490px; border: none; height: 13px;" class="" tabindex="205" readonly="readonly"></textarea>
							...
							<tr>
								...
								<td class="leftAligned"><select style="width: 218px;"
									id="selCurrency" name="selCurrency" tabindex="207" disabled="disabled">
										<option value=""></option>
								</select></td>
								...
								<td class="leftAligned"><input id="txtCurrencyRate"
									...
									max="999.999999999"
									errorMsg="Invalid Currency Rate. Value should be from 0.000000001 to 999.999999999." tabindex="208" readonly="readonly"/>
								</td>
							</tr>
							<tr>
								<td class="rightAligned">Coverage</td>
								<td class="leftAligned"><select style="width: 218px;"
									id="selCoverage" name="selCoverage" tabindex="209" disabled="disabled">
								</select></td>
							</tr>
						</table>
					</div>
...
try{
		...
		var itemInfoListingTable = {
			...
			options: {
				...
				onRemoveRowFocus : function(){
			  	...
			  	beforeSort: function(){
			  		objQuoteGlobal.showQuotationStatus;
				},
			  	onSort : function(){
			  		removeAllRelatedDetails();
			  	},
	...
	function setAdditionalInfoMC(obj) {  // modified by: Nica 06.11.2012 - added unescapeHTML2
		try {
			...
			$("txtCocSerialNo").value  = obj == null ? "" : obj.cocSerialNo == null ? "" : /*unescapeHTML2(*/obj.cocSerialNo/*)*/;  //unescapeHTML2 removed by jeffdojello 04.25.2013 causes str.stripTags error 
	...
	function showAttachedMedia(){
		try {
			mediaTableGrid.url = contextPath+"/GIPIQuotePicturesController?action=getAttachmentsTG&refresh=&quoteId="+objGIPIQuote.quoteId+"&itemNo="+$F("itemNoHid");
			mediaTableGrid._refreshList();
		} catch(e) {
			showErrorMessage("showAttachedMedia", e);
		}
	}
	...
	function removeAllRelatedDetails(){
		...
		objQuoteGlobal.showDeductibleInfoTG(false);
		objQuoteGlobal.setDeductibleInfoForm(null);
		objQuoteGlobal.populatePerilInfoDtls(false);
		objQuoteGlobal.clearMortgageeDtls();
		objQuoteGlobal.selected = false;
		mediaTableGrid.empty(); // SR-21674 JET DEC-06-2016
	}
