...
<div id="contentsDiv"><!-- rename this in the future(to be edited -form) -->
	<div align="left">
		<table>
			<tr>
				...
				<td><input class="button" type="button" style="width: 60px;" onclick="searchBankAcctNoLOV(1);" value="Search" /></td>
			</tr>
		</table>
	</div>
	...
	<div id="divB" align="right" style="margin: 10px; margin-right: 0;">
		<input type="button" class="button" id="btnBankAcctNoLOVModalOk"     value="Ok" 	  style="width: 60px;" />
		<input type="button" class="button" id="btnBankAcctNoLOVModalCancel" value="Cancel" style="width: 60px;"/>
	</div>
</div>
<script type="text/javascript">
	searchBankAcctNoLOV(1);
	...
	$("btnBankAcctNoLOVModalOk").observe("click", function () {
	...
	$("btnBankAcctNoLOVModalCancel").observe("click", function() {
		Modalbox.hide();
	});
</script>