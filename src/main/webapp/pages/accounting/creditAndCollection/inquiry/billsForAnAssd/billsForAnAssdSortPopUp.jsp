<div id="agingSortPopUp" style="width: 95%; margin-top: 5px;">
	<div class="sectionDiv" style="padding: 10px 0 10px 10px; height: 220px; width: 101.6%;">
		<div class="sectionDiv" id="sortOptionDiv" style="width: 45%; height: 140px; margin: 8px 8px 8px 8px;">
			<table border="0" id="chkboxTbl" align="center" style="margin-left: 10px; margin-top: 10px; margin-bottom: 0px;">
				...
				<!-- <tr name="columnTR" id="billNoTR" >
					<td>
						<input id="chkAgeLevel" name="columnCB" type="checkbox" value="column_heading" style="float: left;">
						<label for="chkAgeLevel" id="chkAgeLevel" name="chkboxLbl" style="margin: 2px 0 4px 7px">Age Level</label>
					</td>
				</tr> -->
				<!-- <tr name="columnTR" id="billNoTR" >
					<td>
		...
		<div class="sectionDiv" id="swapDiv" style="width: 42%; height: 140px; margin: 8px 8px 8px 8px;">
			<table  align="center" style="margin-left: 55px; margin-top: 30px; margin-bottom: 0px;">
				<tr>
					<td>
		...
		<div class="sectionDiv" id="ascDescDiv" style="width: 92.5%; height: 60px; margin-left: 8px;">
...
try{
	...
	if (objGIACS207.msortOrder != ""){
		for (var i=1; i<=4; i++){
			$("chkboxTbl").down("tr", i).down("td", 0).down("label", 0).innerHTML = objGIACS207.msortOrder[i-1].columnLabel;
			$("chkboxTbl").down("tr", i).down("td", 0).down("input", 0).value = objGIACS207.msortOrder[i-1].columnValue;
			$("chkboxTbl").down("tr", i).down("td", 0).down("input", 0).checked = objGIACS207.msortOrder[i-1].columnState;
		}
		ascDesc = objGIACS207.msortOrder[0].ascDesc;
		if (ascDesc == " ASC"){
			$("ascRB").checked = true;
		}else{
			$("descRB").checked = true;
	...
	$("btnOk").observe("click", function(){
		...
		for (var i=1; i <= 4; i++){
			...
			objGIACS207.msortOrder.push({columnLabel: $("chkboxTbl").down("tr", i).down("td", 0).down("label", 0).innerHTML,
