...
<script type="text/javascript">
	...
	$("txtCurrCd").value = objCurrGiacs604.currencyCd;
	$("txtCurrDesc").value = objCurrGiacs604.dspCurrency;
	$("txtCollectionAmt").value = formatCurrency(objCurrGiacs604.fcollectionAmt);
	$("txtConvertRate").value = formatToNthDecimal(objCurrGiacs604.convertRate,9);
	$("txtDifference").value = formatCurrency(objCurrGiacs604.dspDifference);
</script>