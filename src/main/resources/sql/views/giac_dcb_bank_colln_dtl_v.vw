DROP VIEW CPI.GIAC_DCB_BANK_COLLN_DTL_V;

/* Formatted on 2015/05/15 10:40 (Formatter Plus v4.8.8) */
CREATE OR REPLACE FORCE VIEW cpi.giac_dcb_bank_colln_dtl_v (gacc_tran_id,
                                                            dcb_no,
                                                            or_date,
                                                            or_pref_suf,
                                                            or_no,
...
AS
   SELECT c.gacc_tran_id, a.dcb_no, a.or_date, a.or_pref_suf, a.or_no,
          a.gibr_gfun_fund_cd, a.gibr_branch_cd, a.with_pdc, a.or_flag,
          a.cancel_date, a.cancel_dcb_no, b.due_dcb_no, b.due_dcb_date,
          b.pay_mode, b.dcb_bank_cd, b.dcb_bank_acct_cd, b.amount
     FROM giac_order_of_payts a, giac_collection_dtl b, giac_dcb_bank_dep c
    WHERE a.gacc_tran_id = b.gacc_tran_id
      AND b.pay_mode = c.pay_mode
      AND a.gibr_branch_cd = c.branch_cd
