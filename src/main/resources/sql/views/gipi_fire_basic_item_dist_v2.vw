/* Formatted on 2016/12/12 14:41 (Formatter Plus v4.8.8) */
DROP VIEW cpi.gipi_fire_basic_item_dist_v2;

CREATE OR REPLACE FORCE VIEW cpi.gipi_fire_basic_item_dist_v2 (par_id,
                                                               line_cd,
                                                               subline_cd,
                                                               iss_cd,
                                                               issue_yy,
...
AS
   SELECT c.par_id, b.line_cd, b.subline_cd, b.iss_cd, b.issue_yy, c.par_yy,
          ...
          i.city, i.block_id, (j.dist_tsi * e.currency_rt) dist_tsi,
          j.share_cd,
             b.line_cd
          || '-'
          || b.iss_cd
          ...
          a.fr_item_type, NVL (a.risk_cd, 0) risk_cd, h.peril_type
    ...
    WHERE e.par_id = b.par_id
      ...
      AND b.pol_flag IN ('1', '2', '3')                --nieko 12052016 KB 894
   ...
   SELECT c.par_id, b.line_cd, b.subline_cd, b.iss_cd, b.issue_yy, c.par_yy,
          ...
          a.loc_risk1 || '' || a.loc_risk2 || '' || a.loc_risk3 loc_risk,
          g.peril_cd, g.prem_rt, h.peril_sname, h.peril_name, i.province_cd,
          i.city, i.block_id, (e.tsi_amt * e.currency_rt) dist_tsi, 1,
             b.line_cd
          || '-'
          || b.iss_cd
          || '-'
