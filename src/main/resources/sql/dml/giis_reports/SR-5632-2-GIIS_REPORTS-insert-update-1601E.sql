BEGIN
      ...
      USING DUAL
         ...
         WHEN NOT MATCHED THEN
            ...
            VALUES ('1601E', 'Monthly Remittance Return of Creditable Income Taxes Withheld (Expanded)', 'FILE', 'NO',
                     'CHARACTER', 'PORTRAIT', 'NO', 'CPI',  
                     SYSDATE, 'Y', 'MAP', 'M', 
                     'Y', 'P', 'N', 'N')
         WHEN MATCHED THEN
            UPDATE
               SET REPORT_TITLE = 'Monthly Remittance Return of Creditable Income Taxes Withheld (Expanded)', DESTYPE = 'FILE' , PARAMFORM= 'NO',
                   REPORT_MODE ='CHARACTER', ORIENTATION='PORTRAIT',BACKGROUND='NO', USER_ID='CPI',
                   LAST_UPDATE = SYSDATE, BIR_TAG = 'Y', BIR_FORM_TYPE = 'MAP', BIR_FREQ_TAG = 'M',
