...
BEGIN
   ...
   IF v_exists = 1
   THEN
      DBMS_OUTPUT.put_line ('GIPIS085 already exists in GIAC_MODULES.');
   END IF;
EXCEPTION
   WHEN NO_DATA_FOUND
   THEN
      ...
      INSERT INTO cpi.giac_modules
           ...
           VALUES (v_module_id, 'GIPIS085', 'ENTER INVOICE COMMISSION', 'S'
                  );

      COMMIT;
      DBMS_OUTPUT.put_line ('Successfully added GIPIS085 in GIAC_MODULES.');
END;