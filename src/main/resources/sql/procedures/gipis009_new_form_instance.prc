DROP PROCEDURE CPI.GIPIS009_NEW_FORM_INSTANCE;

CREATE OR REPLACE PROCEDURE CPI.GIPIS009_NEW_FORM_INSTANCE(
...
AS
 /*
 **  Created by  : D.Alcantaa
 **  Date Created  : 03.04.2010
 **  Reference By  : (GIPIS009 - Marine Hull Item Information)
 **  Description  : Loads new from intance variables for marine hull item information
 */
BEGIN
    /* default currency_cd */
    DECLARE
...
END GIPIS009_NEW_FORM_INSTANCE;
/
