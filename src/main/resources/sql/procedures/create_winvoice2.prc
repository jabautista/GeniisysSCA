CREATE OR REPLACE PROCEDURE CPI.Create_Winvoice2(p_policy_id  IN NUMBER,
      ...
      /*added statements below in order to consider prodtakeup parameter and insert duedate; prevents null value for due date at gipis026 when changing payterm
             ...
             INSERT INTO  GIPI_WINVOICE
                 ...
                 VALUES
                  ...
                  1,                   1)
				LOG ERRORS INTO err$_gipi_winvoice('Insert Error Log 1') REJECT LIMIT 0;
            ELSE
...
--                    NULL,
           ...
           --LONG TERM COLUMNS --
				 ...
				 LOG ERRORS INTO err$_gipi_winvoice('Insert Error Log 2') REJECT LIMIT 0;
...
--                    NULL,  
           ...
           v_booking_mth,        v_booking_year,
           v_no_of_payment,      takeup_val)
		   LOG ERRORS INTO err$_gipi_winvoice('Insert Error Log 3') REJECT LIMIT 0;
    ...
    ELSE
     ...
     0,
           ...
           v_booking_mth,        v_booking_year,
           v_no_of_payment,      takeup_val)
		   LOG ERRORS INTO err$_gipi_winvoice('Insert Error Log 4') REJECT LIMIT 0;
 ...
 CURSOR d2 IS
   ...
   INSERT INTO  GIPI_WINVOICE
      ...
      VALUES
       (p_par_id,            prev_item_grp,
        ...
        v_polbas_book_mm,    v_polbas_book_yy,
        1,                   1)
		LOG ERRORS INTO err$_gipi_winvoice('Insert Error Log 5') REJECT LIMIT 0;
    ELSE
  ...
  IF takeup_val = v_no_of_payment THEN
   ...
   0,
         ...
         v_booking_mth,        v_booking_year,
         v_no_of_payment,      takeup_val)
		 LOG ERRORS INTO err$_gipi_winvoice('Insert Error Log 6') REJECT LIMIT 0;
        ELSIF takeup_val = 1 THEN
   ...
   v_booking_mth,        v_booking_year,
   v_no_of_payment,      takeup_val)
   LOG ERRORS INTO err$_gipi_winvoice('Insert Error Log 7') REJECT LIMIT 0;
...
DROP PROCEDURE CPI.CREATE_WINVOICE2;