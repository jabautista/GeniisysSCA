DROP PROCEDURE CPI.LOSS_RATIO_EXT_BY_SUBLINE;

CREATE OR REPLACE PROCEDURE CPI.loss_ratio_ext_by_subline (p_line_cd            giis_line.line_cd%TYPE,
...
BEGIN
  ...
  LOOP
    ...
    END LOOP;
    --get current lossreserve amount
    FOR curr_loss IN (
