DROP PROCEDURE CPI.RECAP_OSLOSS;

CREATE OR REPLACE PROCEDURE CPI.Recap_Osloss (p_to_date  DATE)
AS
/*
** Modified by   : MAC
  ...
  EXECUTE IMMEDIATE 'TRUNCATE TABLE giac_recap_osloss_ext';
       ...
       INSERT INTO giac_recap_osloss_ext
               (iss_cd, line_cd, subline_cd, claim_id, issue_yy, pol_seq_no,
                ...
                loss_date, clm_file_date, booking_month, booking_year) --include loss_date, clm_file_date, booking_month, and booking_year in Recap OL by MAC 04/11/2014.
      SELECT   a.iss_cd, a.line_cd, a.subline_cd, a.claim_id, a.issue_yy,
               ...
               SUM (DECODE (f.share_type,
                   ...
                   c.dsp_loss_date, c.clm_file_date, c.booking_month, c.booking_year --include loss_date, clm_file_date, booking_month, and booking_year in Recap OL by MAC 04/11/2014.
          FROM gicl_claims a,
               giis_peril b,
               (SELECT a.claim_id, a.item_no, a.peril_cd, d.os_loss,
                       ...
                       c.dsp_loss_date, c.clm_file_date, UPPER(a.booking_month) booking_month, a.booking_year --include loss_date, clm_file_date, booking_month, and booking_year in Recap OL by MAC 04/11/2014.
      ...
      GROUP BY a.iss_cd,
               ...
               f.grp_seq_no,
               a.ri_cd,
               --include loss_date, clm_file_date, booking_month, and booking_year in Recap OL by MAC 04/11/2014.
               c.dsp_loss_date,
               c.clm_file_date,
               c.booking_month,
               c.booking_year;
