DROP PROCEDURE CPI.POP_PACK_MH;

CREATE OR REPLACE PROCEDURE CPI.POP_PACK_MH(p_par_id       IN  GIPI_WITEM.par_id%TYPE,
...
**  Description  : Equivalent to the Program Unit POP_PACK_MH in GIPIS096 module
*/
