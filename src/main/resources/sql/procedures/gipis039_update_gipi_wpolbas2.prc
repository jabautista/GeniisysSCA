DROP PROCEDURE CPI.GIPIS039_UPDATE_GIPI_WPOLBAS2;

CREATE OR REPLACE PROCEDURE CPI.Gipis039_Update_Gipi_Wpolbas2(
  ...
  FOR SW IN(SELECT '1'
             ...
             WHERE B.line_cd      =  v_line_cd
               ...
               AND TRUNC(DECODE(NVL(b.endt_expiry_date, b.expiry_date), b.expiry_date,
                   v_expiry_date2, b.expiry_date,b.endt_expiry_date)) < trunc(v_eff_date)
     ...
     FOR A2 IN ( SELECT b250.ann_tsi_amt  ANN_TSI,
                  ...
                  WHERE b.par_id        = p_par_id
                    ...
                    AND (TRUNC(DECODE(NVL(b250.endt_expiry_date, b250.expiry_date), b250.expiry_date,
                        v_expiry_date2, b250.expiry_date,b250.endt_expiry_date)) >= trunc(v_eff_date) OR
                        p_negate_item = 'Y') 
