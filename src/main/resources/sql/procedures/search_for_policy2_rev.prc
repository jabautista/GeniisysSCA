DROP PROCEDURE CPI.SEARCH_FOR_POLICY2_REV;

CREATE OR REPLACE PROCEDURE CPI.SEARCH_FOR_POLICY2_REV (
...
AS
    ...
    **    ==========    =====================    ============================    
    **    01.10.2012    Veronica V. Raymundo      Retrieve information based on the new specified effectivity date
...
BEGIN    
        ...
        LOOP
            ...
            IF A2.prorate_flag = 1 THEN
                IF A2.endt_expiry_date <= A2.eff_date THEN
                    ...
                    RETURN;                    
                ELSE
                    /*Removed add_months operation on computation of v_prorate.  Replaced
    ...
    LOOP        
        SEARCH_FOR_ASSURED2_1(v_tmp_assd_no, p_eff_date, p_line_cd, p_subline_cd, p_iss_cd, p_issue_yy, p_pol_seq_no, p_renew_no);        
        SEARCH_FOR_ADDRESS2_1(v_tmp_add1, v_tmp_add2, v_tmp_add3, p_eff_date, p_line_cd, p_subline_cd, p_iss_cd, p_issue_yy, p_pol_seq_no, p_renew_no);
