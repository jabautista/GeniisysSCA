DROP PROCEDURE CPI.CREATE_RI_NEW_WDISTFRPS_GIUWS5;

CREATE OR REPLACE PROCEDURE CPI.CREATE_RI_NEW_WDISTFRPS_GIUWS5(
  ...
  ** and DIST_SEQ_NO. */
  INSERT INTO  giri_wdistfrps
              (frps_yy                          , line_cd           , op_group_no      ,
               ...
               dist_seq_no                      , tsi_amt           , tot_fac_spct     , tot_fac_spct2,
       ...
       VALUES (TO_NUMBER(TO_CHAR(SYSDATE,'YY')) , p_line_cd         , NULL             ,
               ...
               p_dist_seq_no                    , p_new_tsi_amt     , p_new_dist_spct  , p_new_dist_spct1,
