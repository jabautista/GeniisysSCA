DROP PROCEDURE CPI.EXTRACT_LATEST_POLICY_TERM;

CREATE OR REPLACE PROCEDURE CPI.EXTRACT_LATEST_POLICY_TERM (p_expiry_date   IN OUT gicl_claims.expiry_date%TYPE,
...
BEGIN
  ...
  UPDATE gicl_claims
     SET expiry_date = NVL(p_expiry_date,p_expiry_date),
         pol_eff_date = NVL(p_incept_date,p_pol_eff_date) 
   WHERE claim_id = p_claim_id;
      
  /*:C003.expiry_date := NVL(p_expiry_date,:C003.expiry_date);
  :C003.pol_eff_date := NVL(p_incept_date,:C003.pol_eff_date);*/
END;
/
