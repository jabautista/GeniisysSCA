DROP PROCEDURE CPI.CREATE_NEGATED_RECORDS_COI01;

CREATE OR REPLACE PROCEDURE CPI.CREATE_NEGATED_RECORDS_COI01 (
...
BEGIN
    ...
    v_max_endt_seq_no := gipi_polbasic_pkg.get_max_endt_seq_no(p_gipi_wpolbas.line_cd, p_gipi_wpolbas.subline_cd, p_gipi_wpolbas.iss_cd,
        p_gipi_wpolbas.issue_yy, p_gipi_wpolbas.pol_seq_no, p_gipi_wpolbas.renew_no, NULL, 'COI_CANCELLATION');
    ...
    IF v_max_endt_seq_no > 0 THEN        
        ...
        IF v_max_endt_seq_no != NVL(v_max_endt_seq_no1,-1) THEN            
            v_max_eff_date1 := gipi_polbasic_pkg.get_max_eff_date_back_stat(p_gipi_wpolbas.line_cd, p_gipi_wpolbas.subline_cd, p_gipi_wpolbas.iss_cd,
                p_gipi_wpolbas.issue_yy, p_gipi_wpolbas.pol_seq_no, p_gipi_wpolbas.renew_no, NULL, v_max_endt_seq_no1, 'COI_CANCELLATION');            
        ...
        ELSE            
            v_max_eff_date := gipi_polbasic_pkg.get_max_eff_date_back_stat(p_gipi_wpolbas.line_cd, p_gipi_wpolbas.subline_cd, p_gipi_wpolbas.iss_cd,
                p_gipi_wpolbas.issue_yy, p_gipi_wpolbas.pol_seq_no, p_gipi_wpolbas.renew_no, NULL, v_max_endt_seq_no1, 'COI_CANCELLATION2');
        END IF;
    ELSE
    ...
    UPDATE GIPI_PARLIST
       SET par_status = 5
     WHERE par_id = p_gipi_wpolbas.par_id;    
END CREATE_NEGATED_RECORDS_COI01;
/
