DROP PROCEDURE CPI.GICLS032_SETUP_FIVE;

CREATE OR REPLACE PROCEDURE CPI.gicls032_setup_five (
...
IS
   ...
   **  Description  : Converted procedure from GICLS032 - setup_five
   */   
   ...
   */
   ...
   IS
      (SELECT   MAX (a.take_up_hist) hist,
                  (d.shr_loss_res_amt + d.shr_exp_res_amt)
                * DECODE (b.currency_cd, p_variables.v_local_currency, 1, NVL (c.orig_curr_rate, c.convert_rate)) disbmt_amt,
                a.peril_cd, b.payee_class_cd, b.payee_cd                                                         --, b.clm_loss_id
          ...
          WHERE a.claim_id = e.claim_id
            ...
            AND b.payee_class_cd = p_payee_class_cd
            AND b.payee_cd = p_payee_cd
       GROUP BY (d.shr_loss_res_amt + d.shr_exp_res_amt),
                a.peril_cd,
                b.payee_class_cd,
                b.payee_cd,
                b.currency_cd,
