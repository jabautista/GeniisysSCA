DROP PROCEDURE CPI.GIACS020_GET_SL_CODE_Y;

CREATE OR REPLACE PROCEDURE CPI.giacs020_get_sl_code_y(P_VAR_SL_TYPE_CD1	IN GIAC_PARAMETERS.param_name%TYPE,
						                          ...
						                          P_GL_LSP        OUT VARCHAR2,
						                          P_GL_ASSD_NO    OUT NUMBER,
								                  P_GL_ACCT_LINE_CD  OUT NUMBER) IS
