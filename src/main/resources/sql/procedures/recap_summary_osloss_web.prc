DROP PROCEDURE CPI.RECAP_SUMMARY_OSLOSS_WEB;

CREATE OR REPLACE PROCEDURE CPI.RECAP_SUMMARY_OSLOSS_WEB AS
   ...
   FUNCTION get_mc_rowtitle(
      ...
      p_rowno   giac_recap_osloss_summ_ext.rowno%TYPE,
      p_rowtitle  giac_recap_osloss_summ_ext.rowtitle%TYPE,
   ...
   PROCEDURE pop_recap_other_rows(
      ...
      v_rowno NUMBER;
      v_exs BOOLEAN := FALSE; --mikel 05.06.2013
