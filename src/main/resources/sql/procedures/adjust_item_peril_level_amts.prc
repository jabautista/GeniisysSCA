DROP PROCEDURE CPI.ADJUST_ITEM_PERIL_LEVEL_AMTS;

CREATE OR REPLACE PROCEDURE CPI.ADJUST_ITEM_PERIL_LEVEL_AMTS(p_dist_no IN giuw_pol_dist.dist_no%TYPE) IS
