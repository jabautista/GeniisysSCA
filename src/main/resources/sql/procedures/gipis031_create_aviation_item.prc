DROP PROCEDURE CPI.GIPIS031_CREATE_AVIATION_ITEM;

CREATE OR REPLACE PROCEDURE CPI.GIPIS031_CREATE_AVIATION_ITEM (
...
AS
	...
	**  Description 	: This procedure is used for inserting records to GIPI_AVIATION_ITEM table
	*/
...
BEGIN
            ...
            FOR B1 IN B(D1.policy_id) LOOP
                IF v_eff_date  IS NULL THEN
                    INSERT INTO gipi_waviation_item (
                        ...
                        est_util_hrs)
                    VALUES (
                        p_par_id,           p_item_no,        b1.vessel_cd,    b1.total_fly_time,
                        b1.qualification,    b1.purpose,        b1.geog_limit,    b1.deduct_text,
                        b1.rec_flag,        b1.fixed_wing,    b1.rotor,        b1.prev_util_hrs,
                        b1.est_util_hrs);
                END IF;
    ...
    ELSE
        ...
        END LOOP;  
    END IF;
END GIPIS031_CREATE_AVIATION_ITEM;
/
