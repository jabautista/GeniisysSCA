DROP PROCEDURE CPI.POP_PACK_OTH;

CREATE OR REPLACE PROCEDURE CPI.POP_PACK_OTH(p_par_id       IN  GIPI_WITEM.par_id%TYPE,
...
**  Description  : Equivalent to the Program Unit POP_PACK_OTH in GIPIS096 module
*/
    ...
    FOR N IN(SELECT a.region_cd region_cd,b.region_desc region_desc
              ...
              WHERE 1=1
                ...
                AND NOT EXISTS (SELECT a.region_cd region_cd
                                  FROM GIPI_ITEM a, GIPI_POLBASIC d
                                 WHERE d.line_cd = p_line_cd
                                   ...
                                   AND c.endt_seq_no > d.endt_seq_no)                  
                      ORDER BY c.eff_date )
    LOOP
