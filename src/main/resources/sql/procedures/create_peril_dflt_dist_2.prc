DROP PROCEDURE CPI.CREATE_PERIL_DFLT_DIST_2;

CREATE OR REPLACE PROCEDURE CPI.CREATE_PERIL_DFLT_DIST_2(
...
BEGIN
  ...
  **  Description  : CREATE_PERIL_DFLT_DIST program unit 
  */
