DROP PROCEDURE CPI.CREATE_DISTRIBUTION_ITEM_PKG2;

CREATE OR REPLACE PROCEDURE CPI.CREATE_DISTRIBUTION_ITEM_PKG2(p_par_id IN GIPI_PARLIST.PAR_ID%TYPE,
...
AS
    ...
    **                    This is Based on the given par_id in the package PAR
    */
    CURSOR C1 IS
...
END CREATE_DISTRIBUTION_ITEM_PKG2;
/
