DROP PROCEDURE CPI.WHEN_NEWFORM_INST_GIPIS038;

CREATE OR REPLACE PROCEDURE CPI.When_Newform_Inst_Gipis038(
...
BEGIN
	 SELECT GIISP.V('ORA2010_SW') 
	   INTO v_ora2010_sw
	   FROM DUAL;
END;

END When_Newform_Inst_Gipis038;
/
