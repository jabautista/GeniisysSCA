DROP PROCEDURE CPI.GIPIS061_UPDATE_GIPI_WPOLBAS2;

CREATE OR REPLACE PROCEDURE CPI.GIPIS061_UPDATE_GIPI_WPOLBAS2 (
    ...
    */ 
    ...
    ELSE
            ...
            ELSE
                IF A2.prorate_flag = 1 THEN
                    IF A2.endt_expiry_date <= A2.eff_date THEN
                        RAISE_APPLICATION_ERROR(20000, 'Your endorsement expiry date is equal to or less than your effectivity date.' ||
        ...
        UPDATE gipi_wpolbas
         ...
         WHERE par_id = p_par_id;
    END IF;
END GIPIS061_UPDATE_GIPI_WPOLBAS2;
/
