DROP PROCEDURE CPI.LRATIO_EXTRACT_BY_LINE;

CREATE OR REPLACE PROCEDURE CPI.Lratio_Extract_By_Line
...
BEGIN
  p_counter :=0;
    FOR curr_prem IN(
      SELECT line_cd, NVL(SUM(prem_amt),0) prem
        FROM gicl_lratio_curr_prem_ext
       WHERE session_id = p_session_id
       AND check_user_per_iss_cd2(line_cd,iss_cd,'GICLS204',USER) = 1 --angelo092407
       GROUP BY line_cd)
    LOOP
      INSERT INTO gicl_loss_ratio_ext
        (session_id,       line_cd ,	        subline_cd,
		 ...
		 user_id)
      VALUES
        (p_session_id,     curr_prem.line_cd,         p_subline_cd ,
    ...
    LOOP
	 ...
	 INSERT INTO gicl_loss_ratio_ext
         (session_id,       line_cd,	       subline_cd,
		  ...
		  user_id)
       VALUES
         (p_session_id,     prev_prem.line_cd,         p_subline_cd,
          p_iss_cd,         p_peril_cd,                p_loss_date,
  ...
  --current loss
  FOR curr_loss IN(
    SELECT line_cd, NVL(SUM(os_amt),0) loss
    ...
    IF v_exists = 'N' THEN
       ...
       INSERT INTO gicl_loss_ratio_ext
         (session_id,       line_cd,	          subline_cd,
		  ...
		  user_id)
       VALUES
         (p_session_id,     curr_loss.line_cd,         p_subline_cd,
          p_iss_cd,         p_peril_cd,                p_loss_date,
    ...
    IF v_exists = 'N' THEN
       ...
       INSERT INTO gicl_loss_ratio_ext
         (session_id,       line_cd,	       subline_cd,
		  ...
		  user_id)
       VALUES
         (p_session_id,     prev_loss.line_cd,         p_subline_cd,
          p_iss_cd,         p_peril_cd,                p_loss_date,
  ...
  --losses paid
  FOR losses IN(
    SELECT line_cd, NVL(SUM(loss_paid),0) loss_paid
    ...
    IF v_exists = 'N' THEN
       ...
       INSERT INTO gicl_loss_ratio_ext
         (session_id,    line_cd,	        subline_cd,
		  ...
		  user_id)
       VALUES
         (p_session_id,  losses.line_cd,         p_subline_cd,
          p_iss_cd,      p_peril_cd,             p_loss_date,
  ...
  --current recovery
  FOR curr_rec IN(
    SELECT line_cd, NVL(SUM(recovered_amt),0) recovery
    ...
    IF v_exists = 'N' THEN
       ...
       INSERT INTO gicl_loss_ratio_ext
         (session_id,      line_cd,	           subline_cd,
		  ...
		  user_id)
       VALUES
         (p_session_id,    curr_rec.line_cd,          p_subline_cd,
          p_iss_cd,        p_peril_cd,                p_loss_date,
    ...
    IF v_exists = 'N' THEN
       ...
       INSERT INTO gicl_loss_ratio_ext
         (session_id,         line_cd,	        subline_cd,
		  ...
		  intm_no)
       VALUES
         (p_session_id,       prev_rec.line_cd,        p_subline_cd,
          p_iss_cd,           p_peril_cd,              p_loss_date,
