DROP PROCEDURE CPI.GIPIS031_VALIDATE_EFF_DATE03_1;

CREATE OR REPLACE PROCEDURE CPI.GIPIS031_VALIDATE_EFF_DATE03_1 (
...
BEGIN
    ...
    SEARCH_FOR_POLICY2_REV(p_par_id,       p_line_cd,       p_subline_cd,    p_iss_cd,       p_issue_yy,     p_pol_seq_no,
                            ...
                            p_assd_name,   v_message,       v_message_type); -- retrieved current info based on entered date
...
END GIPIS031_VALIDATE_EFF_DATE03_1;
/
