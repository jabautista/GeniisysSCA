DROP PROCEDURE CPI.CREATE_NEGATED_RECORDS_COI;

CREATE OR REPLACE PROCEDURE CPI.Create_Negated_Records_Coi (
...
BEGIN
    ...
    v_max_endt_seq_no := Gipi_Polbasic_Pkg.get_max_endt_seq_no(p_line_cd, p_subline_cd, p_iss_cd,
        p_issue_yy, p_pol_seq_no, p_renew_no, NULL, 'COI_CANCELLATION');
    ...
    IF v_max_endt_seq_no > 0 THEN        
        ...
        IF v_max_endt_seq_no != NVL(v_max_endt_seq_no1,-1) THEN            
            ...
            v_max_eff_date1 := Gipi_Polbasic_Pkg.get_max_eff_date_back_stat(p_line_cd, p_subline_cd, p_iss_cd,
                p_issue_yy, p_pol_seq_no, p_renew_no, NULL, v_max_endt_seq_no1, 'COI_CANCELLATION');            
        ...
        ELSE            
            v_max_eff_date := Gipi_Polbasic_Pkg.get_max_eff_date_back_stat(p_line_cd, p_subline_cd, p_iss_cd,
                p_issue_yy, p_pol_seq_no, p_renew_no, NULL, v_max_endt_seq_no1, 'COI_CANCELLATION2');
        END IF;
    ELSE
    ...
    */
    ...
    SELECT *
      FROM GIPI_WITMPERL
     WHERE par_id = p_par_id;
END Create_Negated_Records_Coi;
/
