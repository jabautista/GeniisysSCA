DROP PROCEDURE CPI.GIPIS085_DEFAULT_INTRMDRY;

CREATE OR REPLACE PROCEDURE CPI.GIPIS085_DEFAULT_INTRMDRY (
...
AS
	...
	**  Description 	: Retrieves the default intm in endt
	*/
BEGIN
	DECLARE
