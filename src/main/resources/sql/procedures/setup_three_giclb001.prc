DROP PROCEDURE CPI.SETUP_THREE_GICLB001;

CREATE OR REPLACE PROCEDURE CPI.setup_three_giclb001(
...
IS
    ...
    **  Description     :  SETUP_THREE program unit; 
    **                     Setup THREE - OS_BOOKING_EXP = 'N'      
    */
