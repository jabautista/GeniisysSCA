DROP PROCEDURE CPI.CREATE_NEGATED_RECORDS_FLAT01;

CREATE OR REPLACE PROCEDURE CPI.CREATE_NEGATED_RECORDS_FLAT01 (
...
BEGIN
    ...
    delete_records(p_gipi_wpolbas.par_id, p_gipi_wpolbas.line_cd, p_gipi_wpolbas.subline_cd, 
        p_gipi_wpolbas.iss_cd, p_gipi_wpolbas.issue_yy, p_gipi_wpolbas.pol_seq_no, p_gipi_wpolbas.renew_no,
    ...
    v_max_endt_seq_no := gipi_polbasic_pkg.get_max_endt_seq_no(p_gipi_wpolbas.line_cd, p_gipi_wpolbas.subline_cd, p_gipi_wpolbas.iss_cd,
        p_gipi_wpolbas.issue_yy, p_gipi_wpolbas.pol_seq_no, p_gipi_wpolbas.renew_no, NULL, 'FLAT_CANCELLATION');
    ...
    IF v_max_endt_seq_no > 0 THEN
        ...
        IF v_max_endt_seq_no != NVL(v_max_endt_seq_no1,-1) THEN             
            v_max_eff_date1 := gipi_polbasic_pkg.get_max_eff_date_back_stat(p_gipi_wpolbas.line_cd, p_gipi_wpolbas.subline_cd, p_gipi_wpolbas.iss_cd,
                p_gipi_wpolbas.issue_yy, p_gipi_wpolbas.pol_seq_no, p_gipi_wpolbas.renew_no, NULL, v_max_endt_seq_no1, 'FLAT_CANCELLATION');
        ...
        ELSE
            v_max_eff_date := gipi_polbasic_pkg.get_max_eff_date_back_stat(p_gipi_wpolbas.line_cd, p_gipi_wpolbas.subline_cd, p_gipi_wpolbas.iss_cd,
                p_gipi_wpolbas.issue_yy, p_gipi_wpolbas.pol_seq_no, p_gipi_wpolbas.renew_no, NULL, v_max_endt_seq_no1, 'FLAT_CANCELLATION2');
        END IF;
    ELSE
    ...
    BEGIN
        ...
        gipi_witem_pkg.get_tsi_prem_amt(p_gipi_wpolbas.par_id, p_gipi_wpolbas.tsi_amt, p_gipi_wpolbas.prem_amt);        
        ...
        p_b240_par_status := '5';
    END;    
END CREATE_NEGATED_RECORDS_FLAT01;
/
