DROP PROCEDURE CPI.CREATE_PERIL_DFLT_WITEMDS;

CREATE OR REPLACE PROCEDURE CPI.CREATE_PERIL_DFLT_WITEMDS(
...
BEGIN
  ...
  **  Description  : CREATE_PERIL_DFLT_WITEMDS program unit 
  */
