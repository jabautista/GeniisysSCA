DROP PROCEDURE CPI.LOSS_RATIO_EXT_BY_SUBLINE_INTM;

CREATE OR REPLACE PROCEDURE CPI.Loss_Ratio_Ext_By_Subline_Intm (p_line_cd            giis_line.line_cd%TYPE,
...
BEGIN
  ...
  LOOP
    ...
    END LOOP;
    --insert record in gicl_loss_ratio_ext
    ...
    VALUES (p_session_id,       p_line_cd,          curr_prem.subline_cd,
            p_iss_cd,           p_intm_no,          p_loss_date,
