DROP PROCEDURE CPI.ADJUST_PERIL_LVL_AMTS_GIUWS005;

CREATE OR REPLACE PROCEDURE CPI.ADJUST_PERIL_LVL_AMTS_GIUWS005(p_dist_no IN giuw_pol_dist.dist_no%TYPE) IS
...
BEGIN
  ...
  **  Description  : ADJUST_PERIL_LEVEL_AMTS program unit
  */
