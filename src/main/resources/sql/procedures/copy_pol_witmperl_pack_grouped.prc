DROP PROCEDURE CPI.COPY_POL_WITMPERL_PACK_GROUPED;

CREATE OR REPLACE PROCEDURE CPI.copy_pol_witmperl_pack_grouped(
...
BEGIN
  ...
  **  Description  : copy_pol_witmperl_pack_grouped program unit
  */
  
  /*IF :gauge.process = 'Y' THEN
    :gauge.FILE := 'Finalising Item Grouping info..';
  ELSE
    :gauge.FILE := 'passing copy policy WITMPERL_GROUPED';
  END IF;
  vbx_counter;*/
  BEGIN
