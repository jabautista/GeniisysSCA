DROP PROCEDURE CPI.ADJUST_ITM_PL_LV_AMTS_GIUWS005;

CREATE OR REPLACE PROCEDURE CPI.ADJUST_ITM_PL_LV_AMTS_GIUWS005(p_dist_no IN giuw_pol_dist.dist_no%TYPE) IS
