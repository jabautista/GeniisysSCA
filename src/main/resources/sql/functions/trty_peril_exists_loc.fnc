DROP FUNCTION CPI.TRTY_PERIL_EXISTS_LOC;

CREATE OR REPLACE FUNCTION CPI.trty_peril_exists_loc (
...
IS
   ...
   **  Description   : Converted procedure from GICLS024 - trty_peril_exists_loc program unit
   */
