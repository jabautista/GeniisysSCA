DROP FUNCTION CPI.CHECK_UWREPORTS_PER_PERIL;

CREATE OR REPLACE FUNCTION CPI.CHECK_UWREPORTS_PER_PERIL(
...
RETURN VARCHAR2 AS
    ...
    **  Description   : Checks if there is already an existing extraction (Per Peril/Agent Tab)
    */ 
BEGIN
    SELECT 'Y'
