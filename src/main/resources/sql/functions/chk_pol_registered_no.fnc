DROP FUNCTION CPI.CHK_POL_REGISTERED_NO;

CREATE OR REPLACE FUNCTION CPI.CHK_POL_REGISTERED_NO (p_line_cd      gipi_polbasic.line_cd%TYPE,
  ...
  v_assd_no    GIIS_ASSURED.assd_no%TYPE := Get_Latest_Assured_No2 (p_line_cd,     p_subline_cd,  p_iss_cd,  p_issue_yy, 
