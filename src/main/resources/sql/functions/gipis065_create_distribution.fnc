DROP FUNCTION CPI.GIPIS065_CREATE_DISTRIBUTION;

CREATE OR REPLACE FUNCTION CPI.gipis065_create_distribution (p_par_id IN NUMBER)
   RETURN VARCHAR2
IS
         ...
         BEGIN
            ...
            INSERT INTO giuw_pol_dist
                 ...
                 VALUES (p2_dist_no, p_par_id, p_policy_id, p_endt_type,
                         ...
                         p_expiry_date, SYSDATE, NVL(giis_users_pkg.app_user, USER), SYSDATE,
                         'N'
                        );
         EXCEPTION
            WHEN NO_DATA_FOUND
