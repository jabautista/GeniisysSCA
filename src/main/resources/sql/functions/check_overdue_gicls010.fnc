DROP FUNCTION CPI.CHECK_OVERDUE_GICLS010;

CREATE OR REPLACE FUNCTION CPI.check_overdue_gicls010 (p_func_name VARCHAR2, p_module_id VARCHAR2, p_user VARCHAR2)
   RETURN VARCHAR2
IS
