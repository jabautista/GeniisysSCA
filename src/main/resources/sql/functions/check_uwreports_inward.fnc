DROP FUNCTION CPI.CHECK_UWREPORTS_INWARD;

CREATE OR REPLACE FUNCTION CPI.CHECK_UWREPORTS_INWARD(
...
RETURN VARCHAR2 AS
    ...
    **  Description   : Checks if there is already an existing extraction (Inward Ri Tab)
    */ 
BEGIN
    SELECT 'Y'
