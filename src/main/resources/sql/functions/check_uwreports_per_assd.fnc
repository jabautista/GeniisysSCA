DROP FUNCTION CPI.CHECK_UWREPORTS_PER_ASSD;

CREATE OR REPLACE FUNCTION CPI.CHECK_UWREPORTS_PER_ASSD(
...
RETURN VARCHAR2 AS
    ...
    **  Description   : Checks if there is already an existing extraction (Per Assd/Intm Tab)
    */ 
BEGIN
    SELECT 'Y'
