DROP FUNCTION CPI.CHECK_USER_PER_ISS_CD_ACCTG;

CREATE OR REPLACE FUNCTION CPI."CHECK_USER_PER_ISS_CD_ACCTG" (p_line_cd   VARCHAR2
         , p_iss_cd    VARCHAR2
   ...
   LOOP
      ...
      BEGIN
          SELECT access_tag
           ...
           WHERE /* user_grp = a.user_grp  -- jhing replaced with: */ userid = user
