DROP FUNCTION CPI.CHECK_UWREPORTS_OUTWARD;

CREATE OR REPLACE FUNCTION CPI.CHECK_UWREPORTS_OUTWARD(
...
RETURN VARCHAR2 AS
    ...
    **  Description   : Checks if there is already an existing extraction (Outward Ri Tab)
    */ 
BEGIN
    SELECT 'Y'
