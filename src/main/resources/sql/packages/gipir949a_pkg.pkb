CREATE OR REPLACE PACKAGE BODY CPI.GIPIR949A_PKG
AS
    /** Created By:     Shan Bati
     ** Date Created:   09.20.2013
     ** Referenced By:  GIPIR949A - Risk Profile (By Line and Subline)
     **/
    ...
    BEGIN
        ...
        FOR i IN  ( SELECT tarf_cd, range_from, range_to, 
                           ...
                           ann_tsi_amt, net_retention netret_prem, facultative facul_prem, quota_share quota_prem, treaty_prem
