CREATE OR REPLACE PACKAGE BODY CPI.giacr122_pkg
AS
   ...
   AS
      v_list   giacr122_dtls_type;
   BEGIN
      v_list.report_title := 'DISTRIBUTION REGISTER PER POLICY';
      ...
      FOR i IN (SELECT   a.acct_ent_date, b.line_name "LINE_NAME",
                         c.subline_cd "SUBLINE_CODE", a.policy_no "POLICY_NO",
                         ...
                         + SUM (NVL (a.fa_dist_prem, 0)) "TOTAL_PREMIUM",
                         b.line_cd
      ...
      LOOP
         ...
         v_list.subline_cd := i.subline_code;
