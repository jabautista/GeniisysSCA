CREATE OR REPLACE PACKAGE BODY CPI.populate_giclr042_pkg
AS 

/*
**  Created by   :  Belle Bebing
**  Date Created :  11.21.2011
**  Reference By : POPULATE_GICLR042_UCPB (GICLS041 - Print Documents) 
**  Description  : Populate GICLR042 for UCPB 
*/
