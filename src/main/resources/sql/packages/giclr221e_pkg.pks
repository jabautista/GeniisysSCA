CREATE OR REPLACE PACKAGE CPI.GICLR221E_PKG
AS
   ...
   */
   ...
   TYPE giclr221e_parent_type IS RECORD (
      enrollee         gicl_res_brdrx_extr.enrollee%TYPE,
   ...
   TYPE giclr221e_parent_tab IS TABLE OF giclr221e_parent_type;
   ...
   TYPE giclr221e_claim_type IS RECORD(
      claim_id             GICL_RES_BRDRX_EXTR.claim_id%TYPE,
      claim_no             GICL_RES_BRDRX_EXTR.claim_no%TYPE,
   ...
   TYPE giclr221e_claim_tab IS TABLE OF giclr221e_claim_type;
   ...
   TYPE giclr221e_item_main_type IS RECORD(
      claim_id             GICL_RES_BRDRX_EXTR.claim_id%TYPE,
      claim_no             GICL_RES_BRDRX_EXTR.claim_no%TYPE,
      policy_no            GICL_RES_BRDRX_EXTR.policy_no%TYPE,
      enrollee             GICL_RES_BRDRX_EXTR.enrollee%TYPE,
   ...
   TYPE giclr221e_item_main_tab IS TABLE OF giclr221e_item_main_type;
   ...
   TYPE giclr221e_item_type IS RECORD(
      claim_id             GICL_RES_BRDRX_EXTR.claim_id%TYPE,
      claim_no             GICL_RES_BRDRX_EXTR.claim_no%TYPE,
      policy_no            GICL_RES_BRDRX_EXTR.policy_no%TYPE,
      enrollee             GICL_RES_BRDRX_EXTR.enrollee%TYPE,
   ...
   TYPE giclr221e_item_tab IS TABLE OF giclr221e_item_type;
   ...
   TYPE total_paid_expenses_type IS RECORD(
      total_paid_expenses  GICL_RES_BRDRX_EXTR.expenses_paid%TYPE
   );
   TYPE total_paid_expenses_tab IS TABLE OF total_paid_expenses_type;
