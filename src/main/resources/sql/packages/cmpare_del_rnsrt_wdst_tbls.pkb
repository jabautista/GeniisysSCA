CREATE OR REPLACE PACKAGE BODY CPI.cmpare_del_rnsrt_wdst_tbls
AS
   ...
   BEGIN
      ...
      THEN
         cmpare_del_rnsrt_wdst_tbls.del_rnsrt_wdst_tbls (p_dist_no);
      END IF;
   END;
...
DROP PACKAGE BODY CPI.CMPARE_DEL_RNSRT_WDST_TBLS;
