CREATE OR REPLACE PACKAGE BODY CPI.giacr249_pkg
AS
   FUNCTION get_giacr249_dtls (
      p_from_date    DATE,
      p_to_date      DATE,
      ...
      RETURN giacr249_dtls_tab PIPELINED
   AS
      v_list   giacr249_dtls_type;
   BEGIN
      v_list.report_title :=
         'DISTRIBUTION REGISTER OF PREVIOUSLY TAKEN UP POLICIES PER LINE SUBLINE';
