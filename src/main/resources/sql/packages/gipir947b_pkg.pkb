CREATE OR REPLACE PACKAGE BODY CPI.gipir947b_pkg
AS
   /*
      **  Created by   : Shan Bati
      **  Date Created : 09.23.2013
      **  Reference By : GIPIR947B
   ...
   FUNCTION get_gipir947b_record (
      ...
      RETURN gipir947b_record_tab PIPELINED
   IS
      v_rec   gipir947b_record_type;
      mjm     BOOLEAN              := TRUE;
   BEGIN
