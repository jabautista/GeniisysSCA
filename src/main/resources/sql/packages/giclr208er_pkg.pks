CREATE OR REPLACE PACKAGE CPI.giclr208er_pkg
AS
   TYPE get_giclr208er_report_type IS RECORD (
   ...
   TYPE get_giclr208er_report_tab IS TABLE OF get_giclr208er_report_type;
