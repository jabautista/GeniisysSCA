CREATE OR REPLACE PACKAGE BODY CPI.giacr184_pkg
AS
   /*
   **  Created by   : Steven Ramirez
   **  Date Created : 06.21.2013
   **  Reference By : GIACR184 - SCHEDULE OF PREMIUMS CEDED TO FACULTATIVE RI (Detail)
   **  Description  :
   */
