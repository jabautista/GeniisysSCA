CREATE OR REPLACE PACKAGE CPI.GICLR206E_PKG
AS
   ...
   -- marco
   -- added lines below for matrix
      
   TYPE giclr206e_main_type IS RECORD (
      dummy                NUMBER(10),
      iss_type             VARCHAR2(2),
      buss_source_type     VARCHAR2(2),
      iss_cd               giis_issource.iss_cd%TYPE,
   ...
   TYPE giclr206e_main_tab IS TABLE OF giclr206e_main_type;
   
   TYPE giclr206e_detail_type IS RECORD(
   ...
   TYPE giclr206e_detail_tab IS TABLE OF giclr206e_detail_type;
   ...
   TYPE giclr206e_item_type IS RECORD(
      policy_no            GICL_RES_BRDRX_EXTR.policy_no%TYPE,
      claim_id             GICL_RES_BRDRX_EXTR.claim_id%TYPE,
      claim_no             GICL_RES_BRDRX_EXTR.claim_no%TYPE,
   ...
   TYPE giclr206e_item_tab IS TABLE OF giclr206e_item_type;
   
   TYPE giclr206e_peril_type IS RECORD(
      tsi_amt              GICL_RES_BRDRX_EXTR.tsi_amt%TYPE,
   ...
   TYPE giclr206e_peril_tab IS TABLE OF giclr206e_peril_type;
