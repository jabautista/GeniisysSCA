CREATE OR REPLACE PACKAGE CPI.gipir946b_pkg   
AS
   TYPE get_data_type IS RECORD (
      iss_cd              VARCHAR2(1000),
      iss_name            VARCHAR2(1000),
      ...
      tsi_basic           NUMBER (20, 2),
      sumtsi              NUMBER (20, 2),
      sumprem             NUMBER (20, 2),
      cf_commission       NUMBER (20, 2),
      cf_new_commission   NUMBER (20, 2),
      cf_iss_name         VARCHAR2 (100),
      cf_subline_name     VARCHAR2 (100),
   ...
   TYPE gipir946b_dt_tab IS TABLE OF get_data_type;
