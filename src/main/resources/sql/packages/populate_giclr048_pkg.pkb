CREATE OR REPLACE PACKAGE BODY CPI.populate_giclr048_pkg
AS 

/*
**  Created by   :  Belle Bebing
**  Date Created :  11.21.2011
**  Reference By : POPULATE_GICLR048_UCPB (GICLS041 - Print Documents) 
**  Description  : Populate GICLR048 for UCPB 
*/
FUNCTION populate_giclr048_UCPB(
