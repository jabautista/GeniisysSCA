CREATE OR REPLACE PACKAGE BODY CPI.giacr247_pkg
AS
   FUNCTION get_giacr247_dtls (
      p_from_date    DATE,
      p_to_date      DATE,
      ...
      RETURN giacr247_dtls_tab PIPELINED
   AS
      v_list   giacr247_dtls_type;
   BEGIN
      v_list.report_title :=
               'DISTRIBUTION REGISTER OF CURRENTLY TAKEN UP PER LINE SUBLINE';
      ...
      FOR i IN (SELECT   b.line_name "LINE_NAME",
                         c.subline_name "SUBLINE_NAME", a.iss_cd iss_cd,
