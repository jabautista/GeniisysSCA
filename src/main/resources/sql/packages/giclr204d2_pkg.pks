CREATE OR REPLACE PACKAGE CPI.GICLR204D2_PKG AS
...
TYPE outstndng_loss_as_of_prev_type IS RECORD(
...
TYPE outstndng_loss_as_of_prev_tab IS TABLE OF outstndng_loss_as_of_prev_type;
