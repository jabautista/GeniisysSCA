CREATE OR REPLACE PACKAGE CPI.GIEXR106B_PKG
AS
...
TYPE get_details_type IS RECORD(
            ...
            INTM_NO             VARCHAR2(9000), -- bonok :: 09.06.2012 temp solution for ORA-06502 
            STARTING_DATE       DATE,
            ENDING_DATE         DATE,
            ISS_NAME            VARCHAR2(100),
            ASSD_NAME           giis_assured.assd_name%TYPE, --editted by MJ for consolidation 01022013 [FROM VARCHAR2(100)]
