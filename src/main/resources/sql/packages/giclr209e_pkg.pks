CREATE OR REPLACE PACKAGE CPI.GICLR209E_PKG
AS 
   TYPE get_giclr209e_report_type IS RECORD (
   ...
   TYPE get_giclr209e_report_tab IS TABLE OF get_giclr209e_report_type; 
