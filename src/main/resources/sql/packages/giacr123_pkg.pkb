CREATE OR REPLACE PACKAGE BODY CPI.giacr123_pkg
AS
   FUNCTION get_giacr123_dtls (
      p_from_date    DATE,
      p_to_date      DATE,
      ...
      RETURN giacr123_dtls_tab PIPELINED
   AS
      v_list   giacr123_dtls_type;
   BEGIN
      v_list.report_title := 'DISTRIBUTION REGISTER PER PERIL';
      ...
      FOR i IN (SELECT   b.line_name, c.subline_cd, d.peril_name,
                         DECODE (a.peril_type,
                                 'A', 0,
