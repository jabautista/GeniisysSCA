CREATE OR REPLACE PACKAGE BODY CPI.giacr248_pkg
AS
   FUNCTION get_giacr248_dtls (
      p_from_date    DATE,
      p_to_date      DATE,
      ...
      RETURN giacr248_dtls_tab PIPELINED
   AS
      v_list   giacr248_dtls_type;
   BEGIN
      v_list.report_title :=
                 'DISTRIBUTION REGISTER OF NEGATED POLICIES PER LINE SUBLINE';
