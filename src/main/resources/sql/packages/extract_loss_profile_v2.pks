CREATE OR REPLACE PACKAGE CPI.EXTRACT_LOSS_PROFILE_V2 AS
/* BY: PAU
   DATE: 28NOV06
...
** Modifications: This version of Extract_Loss_Profile used the function check_user_per_iss_cd2 in the body. 
*/
