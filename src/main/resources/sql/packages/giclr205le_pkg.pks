CREATE OR REPLACE PACKAGE CPI.GICLR205LE_PKG
AS
    ...
    TYPE report_details_type IS RECORD(
        ...
        prnt_assignee_flg       VARCHAR2(1),
        cf_item_title           VARCHAR2(200),
        grouped_item_no         GICL_RES_BRDRX_EXTR.GROUPED_ITEM_NO%TYPE,
        clm_res_hist_id         GICL_RES_BRDRX_EXTR.CLM_RES_HIST_ID%type,
        ...
        outstanding_expense     GICL_RES_BRDRX_EXTR.EXPENSE_RESERVE%TYPE,
    ...
    TYPE treaty_details_type IS RECORD(
        ...
        facul_outstanding_expense3  GICL_RES_BRDRX_RIDS_EXTR.EXPENSE_RESERVE%type
    );
    ...
    TYPE treaty_ri_type IS RECORD(
        ...
        ri_outstanding_expense4     GICL_RES_BRDRX_RIDS_EXTR.EXPENSE_RESERVE%type
    );
    ...
    TYPE trty_type IS RECORD(
        ...
        outstanding_expense5    GICL_RES_BRDRX_EXTR.EXPENSES_PAID%TYPE 
    );
   ...
   TYPE giclr205le_parent_type IS RECORD (
   ...
   TYPE giclr205le_parent_tab IS TABLE OF giclr205le_parent_type;
   ...
   TYPE giclr205le_claim_type IS RECORD(
      claim_id             GICL_RES_BRDRX_EXTR.claim_id%TYPE,
      claim_no             GICL_RES_BRDRX_EXTR.claim_no%TYPE,
      policy_no            GICL_RES_BRDRX_EXTR.policy_no%TYPE,
   ...
   TYPE giclr205le_claim_tab IS TABLE OF giclr205le_claim_type;
   ...
   TYPE giclr205le_item_main_type IS RECORD(
      claim_id             GICL_RES_BRDRX_EXTR.claim_id%TYPE,
      claim_no             GICL_RES_BRDRX_EXTR.claim_no%TYPE,
      policy_no            GICL_RES_BRDRX_EXTR.policy_no%TYPE,
      item_no              GICL_RES_BRDRX_EXTR.item_no%TYPE,
      ...
      grouped_item_no      gicl_res_brdrx_extr.grouped_item_no%TYPE,
      clm_res_hist_id      gicl_res_brdrx_extr.clm_res_hist_id%TYPE,
      booking_month        VARCHAR2(500), --Added by carlo
      tsi_amt              GICL_RES_BRDRX_EXTR.tsi_amt%TYPE, --Added by carlo
      peril_name           GIIS_PERIL.peril_name%TYPE --Added by carlo
   );
   TYPE giclr205le_item_main_tab IS TABLE OF giclr205le_item_main_type;
   ...
   TYPE giclr205le_item_type IS RECORD(
      claim_id             GICL_RES_BRDRX_EXTR.claim_id%TYPE,
      claim_no             GICL_RES_BRDRX_EXTR.claim_no%TYPE,
      policy_no            GICL_RES_BRDRX_EXTR.policy_no%TYPE,
      item_no              GICL_RES_BRDRX_EXTR.item_no%TYPE,
      ...
      brdrx_record_id      GICL_RES_BRDRX_EXTR.brdrx_record_id%TYPE,
      --booking_month        VARCHAR2(500), comment out by carlo
      intm_no              GICL_RES_BRDRX_EXTR.intm_no%TYPE --Added by carlo
   );
   TYPE giclr205le_item_tab IS TABLE OF giclr205le_item_type;
   ...
   TYPE outstanding_le_type_v IS RECORD(
   ...
   TYPE outstanding_le_tab_v IS TABLE OF outstanding_le_type_v;
