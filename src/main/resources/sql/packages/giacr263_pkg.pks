CREATE OR REPLACE PACKAGE CPI.giacr263_pkg
AS
   TYPE giacr263_dtls_type IS RECORD (
   ...
   TYPE giacr263_dtls_tab IS TABLE OF giacr263_dtls_type;

   FUNCTION get_giacr263_dtls (
      p_from_date    DATE,
      p_to_date      DATE,
      ...
      RETURN giacr263_dtls_tab PIPELINED;
END;
/
