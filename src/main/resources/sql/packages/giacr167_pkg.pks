CREATE OR REPLACE PACKAGE CPI.GIACR167_PKG
AS
    TYPE giacr167_off_receipt_reg_type IS RECORD (
    ...
    TYPE giacr167_off_receipt_reg_tab IS TABLE OF giacr167_off_receipt_reg_type;
