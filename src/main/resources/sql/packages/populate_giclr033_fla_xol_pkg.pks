CREATE OR REPLACE PACKAGE CPI.populate_giclr033_fla_xol_pkg AS
   TYPE populate_reports_type IS RECORD (
      ...
      wrd_assured       gicl_claims.assured_name%TYPE, -- bonok :: 10.23.2015 :: UCPB 20775
...
END populate_giclr033_fla_xol_pkg;
/
