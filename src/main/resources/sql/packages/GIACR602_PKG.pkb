CREATE OR REPLACE PACKAGE BODY GIACR602_PKG
AS
   /*
   ...
   */
   ...
   AS
        v_rec               POPULATE_GIACR602_TRAN1_A_TYPE; 
        v_ref_no            VARCHAR(50);
        v_pref              VARCHAR(10);
        v_temp_no           NUMBER(38);
   ...
   AS
        v_rec               POPULATE_GIACR602_TRAN1_B_TYPE; 
        v_ref_no            VARCHAR(50);
        v_pref              VARCHAR(10);
        v_temp_no           NUMBER(38);
        v_particulars       VARCHAR2 (2100);        
   ...
   AS
        v_rec           POPULATE_GIACR602_TRAN2_TYPE; 
        v_ref_no            VARCHAR(50);
        v_pref              VARCHAR(10);
        v_temp_no           NUMBER(38);
        v_particulars       VARCHAR2 (2100);           
   ...
   AS
        v_rec               POPULATE_GIACR602_TRAN3_TYPE; 
        v_ref_no            VARCHAR(50);
        v_pref              VARCHAR(10);
        v_temp_no           NUMBER(38);
        v_particulars       VARCHAR2 (2100);       
   ...
   AS
        v_rec               POPULATE_GIACR602_TRAN4_TYPE;
        v_ref_no            VARCHAR(50);
        v_pref              VARCHAR(10);
        v_temp_no           NUMBER(38);
        v_particulars       VARCHAR2 (2100);            
   ...
   AS
        v_rec           POPULATE_GIACR602_TRAN5_TYPE; 
   BEGIN
