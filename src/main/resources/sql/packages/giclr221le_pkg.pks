CREATE OR REPLACE PACKAGE CPI.GICLR221LE_PKG
AS
   ...
   TYPE giclr221le_parent_type IS RECORD (
      enrollee          gicl_res_brdrx_extr.enrollee%TYPE,
   ...
   TYPE giclr221le_parent_tab IS TABLE OF giclr221le_parent_type;
   ...
   TYPE giclr221le_claim_type IS RECORD(
      claim_id             GICL_RES_BRDRX_EXTR.claim_id%TYPE,
      claim_no             GICL_RES_BRDRX_EXTR.claim_no%TYPE,
   ...
   TYPE giclr221le_claim_tab IS TABLE OF giclr221le_claim_type;
   ...
   TYPE giclr221le_item_main_type IS RECORD(
      claim_id             GICL_RES_BRDRX_EXTR.claim_id%TYPE,
      claim_no             GICL_RES_BRDRX_EXTR.claim_no%TYPE,
      policy_no            GICL_RES_BRDRX_EXTR.policy_no%TYPE,
      enrollee             GICL_RES_BRDRX_EXTR.enrollee%TYPE,
   ...
   TYPE giclr221le_item_main_tab IS TABLE OF giclr221le_item_main_type;
   ...
   TYPE giclr221le_item_type IS RECORD(
      claim_id             GICL_RES_BRDRX_EXTR.claim_id%TYPE,
      claim_no             GICL_RES_BRDRX_EXTR.claim_no%TYPE,
      policy_no            GICL_RES_BRDRX_EXTR.policy_no%TYPE,
      enrollee             GICL_RES_BRDRX_EXTR.enrollee%TYPE,
   ...
   TYPE giclr221le_item_tab IS TABLE OF giclr221le_item_type;
   ...
   TYPE paid_lossexpense_type_v IS RECORD(
   ...
   TYPE paid_lossexpense_tab_v IS TABLE OF paid_lossexpense_type_v;
   ...
   TYPE total_paid_lossexpenses_type IS RECORD(
      total_paid_losses    GICL_RES_BRDRX_EXTR.losses_paid%TYPE,
      total_paid_expenses  GICL_RES_BRDRX_EXTR.expenses_paid%TYPE
   );
   TYPE total_paid_lossexpenses_tab IS TABLE OF total_paid_lossexpenses_type;
