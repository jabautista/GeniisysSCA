CREATE OR REPLACE PACKAGE BODY CPI.CSV_CLM_PER_COLOR_GICLR264
AS
/*
...
*/
   ...
   BEGIN
      SELECT SUM (NVL(a.convert_rate,1) * a.loss_reserve)
        INTO v_los_res
   ...
   BEGIN
      SELECT SUM (NVL(a.convert_rate,1) * a.expense_reserve)
        INTO v_exp_res
        FROM gicl_clm_reserve a, gicl_motor_car_dtl b
       WHERE b.color_cd = p_color_cd
         AND b.item_no = a.item_no
