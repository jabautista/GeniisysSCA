CREATE OR REPLACE PACKAGE CPI.GIEXR105_PKG
AS


TYPE get_details_type IS RECORD(
            pack_policy_id      giex_pack_expiry.pack_policy_id%TYPE,   --Gzelle 03182016 SR5321
            ...
            COMPANY_NAME        giis_parameters.param_value_v%TYPE, --VARCHAR2(100), changed by robert 09182013
            COMPANY_ADDRESS     giis_parameters.param_value_v%TYPE, --VARCHAR2(100), changed by robert 09182013
