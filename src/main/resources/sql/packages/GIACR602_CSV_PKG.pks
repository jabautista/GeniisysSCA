CREATE OR REPLACE PACKAGE CPI.GIACR602_CSV_PKG
AS
   /*
   ...
   */
   ...
   TYPE GIACR602_TRAN1_A_TYPE IS RECORD (
   ...
   TYPE GIACR602_TRAN1_A_TAB IS TABLE OF GIACR602_TRAN1_A_TYPE;   
-------------------------------------------------------------------------------   
   TYPE GIACR602_TRAN1_B_TYPE IS RECORD (
        SOURCE_CD           GIAC_UPLOAD_FILE.SOURCE_CD%TYPE,
        SOURCE              GIAC_FILE_SOURCE.SOURCE_NAME%TYPE,
        TRAN_TYPE           GIAC_UPLOAD_FILE.TRANSACTION_TYPE%TYPE,        
        TRANSACTION         CG_REF_CODES.RV_MEANING%TYPE,
   ...
   TYPE GIACR602_TRAN1_B_TAB IS TABLE OF GIACR602_TRAN1_B_TYPE; 
-------------------------------------------------------------------------------   
   TYPE GIACR602_TRAN2_TYPE IS RECORD (
        SOURCE_CD           GIAC_UPLOAD_FILE.SOURCE_CD%TYPE,
        SOURCE              GIAC_FILE_SOURCE.SOURCE_NAME%TYPE,
        TRAN_TYPE           GIAC_UPLOAD_FILE.TRANSACTION_TYPE%TYPE,        
        TRANSACTION         CG_REF_CODES.RV_MEANING%TYPE,
   ...
   TYPE GIACR602_TRAN2_TAB IS TABLE OF GIACR602_TRAN2_TYPE;
-------------------------------------------------------------------------------   
   TYPE GIACR602_TRAN3_TYPE IS RECORD (
        SOURCE_CD           GIAC_UPLOAD_FILE.SOURCE_CD%TYPE,
        SOURCE              GIAC_FILE_SOURCE.SOURCE_NAME%TYPE,
        TRAN_TYPE           GIAC_UPLOAD_FILE.TRANSACTION_TYPE%TYPE,        
        TRANSACTION         CG_REF_CODES.RV_MEANING%TYPE,
   ...
   TYPE GIACR602_TRAN3_TAB IS TABLE OF GIACR602_TRAN3_TYPE;   
-------------------------------------------------------------------------------   
   TYPE GIACR602_TRAN4_TYPE IS RECORD (
        SOURCE_CD           GIAC_UPLOAD_FILE.SOURCE_CD%TYPE,
        SOURCE              GIAC_FILE_SOURCE.SOURCE_NAME%TYPE,
        TRAN_TYPE           GIAC_UPLOAD_FILE.TRANSACTION_TYPE%TYPE,        
        TRANSACTION         CG_REF_CODES.RV_MEANING%TYPE,
   ...
   TYPE GIACR602_TRAN4_TAB IS TABLE OF GIACR602_TRAN4_TYPE;  
-------------------------------------------------------------------------------   
   TYPE GIACR602_TRAN5_TYPE IS RECORD (
        SOURCE_CD           GIAC_UPLOAD_FILE.SOURCE_CD%TYPE,
        SOURCE              GIAC_FILE_SOURCE.SOURCE_NAME%TYPE,
        TRAN_TYPE           GIAC_UPLOAD_FILE.TRANSACTION_TYPE%TYPE,        
        TRANSACTION         CG_REF_CODES.RV_MEANING%TYPE,
   ...
   TYPE GIACR602_TRAN5_TAB IS TABLE OF GIACR602_TRAN5_TYPE;                
