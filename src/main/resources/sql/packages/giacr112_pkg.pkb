CREATE OR REPLACE PACKAGE BODY CPI.giacr112_pkg AS         
...
RETURN giacr112_tab PIPELINED AS
 ...
 IF NVL(p_tran_tag, 'N') = 'N'
  THEN   
    ...
    LOOP
        ...
        --v_rec.whtax_code    := i.whtax_code; Comment out by pjsantos 01/03/2017, GENQA 5898
...
--        v_rec.income_amt_tot := 0;
        ...
        FOR b IN (SELECT b.payee_no,
						 b.payee_class_cd,
						 --c.whtax_code, Comment out by pjsantos 01/03/2017, GENQA 5898
						 c.bir_tax_cd, 
				  ...
				  AND d.gacc_tran_id NOT IN (SELECT e.gacc_tran_id
							                 ...
							                 --AND c.whtax_code = i.whtax_code   Comment out by pjsantos 01/03/2017, GENQA 5898
