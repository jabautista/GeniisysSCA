CREATE OR REPLACE PACKAGE BODY CPI.giacr260_pkg
AS
   FUNCTION get_giacr260_dtls (
      p_from_date    DATE,
      p_to_date      DATE,
      ...
      RETURN giacr260_dtls_tab PIPELINED
   AS
      v_list   giacr260_dtls_type;
   BEGIN
      v_list.report_title := 'DISTRIBUTION REGISTER OF ALL POLICIES';
      ...
      FOR i IN (SELECT   d.line_name, c.subline_name, a.iss_cd, a.line_cd,
                   ...
                   WHERE a.policy_id = b.policy_id
                     ...
                     AND a.user_id = p_user         --added by albert 12.04.2015; FGIC SR 21083: displayed report should be per user
