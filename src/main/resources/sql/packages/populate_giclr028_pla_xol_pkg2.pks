CREATE OR REPLACE PACKAGE CPI.populate_giclr028_pla_xol_pkg2 AS
   ...
   TYPE pla_xol_dist_type2 IS RECORD (
   ...
   TYPE pla_xol_dist_tab2 IS TABLE OF pla_xol_dist_type2;
...
END populate_giclr028_pla_xol_pkg2;
/
